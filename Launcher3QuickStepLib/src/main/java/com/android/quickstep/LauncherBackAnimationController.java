    ...
    public LauncherBackAnimationController(
        ...
        mWindowScaleEndCornerRadius = QuickStepContract.supportsRoundedCornersOnWindows(
                ...
                ? mLauncher.getResources().getDimensionPixelSize(
                        com.android.launcher3.res.R.dimen.swipe_back_window_corner_radius)
                : 0;
        ...
        mWindowScaleMarginX = mLauncher.getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.swipe_back_window_scale_x_margin);
        mWindowMaxDeltaY = mLauncher.getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.swipe_back_window_max_delta_y);
        mCancelInterpolator =
                AnimationUtils.loadInterpolator(mLauncher, com.android.launcher3.res.R.interpolator.back_cancel);
    }
