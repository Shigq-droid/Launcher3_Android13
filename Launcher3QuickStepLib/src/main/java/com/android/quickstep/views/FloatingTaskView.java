...
public class FloatingTaskView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mThumbnailView = findViewById(com.android.launcher3.res.R.id.thumbnail);
    ...
    private void init(StatefulActivity launcher, View originalView, @Nullable Bitmap thumbnail,
        ...
        mSplitPlaceholderView.setLayoutParams(new LayoutParams(lp.width, lp.height));
        setPivotX(0);
        setPivotY(0);
        ...
        mSplitPlaceholderView.setIcon(icon,
                mContext.getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.split_placeholder_icon_size));
    ...
    public static FloatingTaskView getFloatingTaskView(StatefulActivity launcher,
        ...
        final FloatingTaskView floatingView = (FloatingTaskView) launcher.getLayoutInflater()
                .inflate(com.android.launcher3.res.R.layout.floating_split_select_view, parent, false);
