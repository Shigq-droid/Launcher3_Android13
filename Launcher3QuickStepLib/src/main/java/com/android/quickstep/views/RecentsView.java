...
public abstract class RecentsView<ACTIVITY_TYPE extends StatefulActivity<STATE_TYPE>,
    ...
    public RecentsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr,
        ...
        mSplitPlaceholderSize = getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.split_placeholder_size);
        mSplitPlaceholderInset = getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.split_placeholder_inset);
    ...
    private void addDismissedTaskAnimations(TaskView taskView, long duration,
        ...
        SpringProperty sp = new SpringProperty(SpringProperty.FLAG_CAN_SPRING_ON_START)
                .setDampingRatio(rp.getFloat(com.android.launcher3.res.R.dimen.dismiss_task_trans_y_damping_ratio))
                .setStiffness(rp.getFloat(com.android.launcher3.res.R.dimen.dismiss_task_trans_y_stiffness));
    ...
    public float getSplitSelectTranslation() {
        ...
        return mActivity.getResources().getDimension(com.android.launcher3.res.R.dimen.split_placeholder_size) * direction;
    }
    ...
    public static int getForegroundScrimDimColor(Context context) {
        int baseColor = Themes.getAttrColor(context, com.android.launcher3.res.R.attr.overviewScrimColor);
