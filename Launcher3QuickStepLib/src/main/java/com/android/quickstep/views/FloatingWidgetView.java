...
public class FloatingWidgetView extends FrameLayout implements AnimatorListener,
    ...
    private void finish(DragLayer dragLayer) {
        ...
        recycle();
        mLauncher.getViewCache().recycleView(com.android.launcher3.res.R.layout.floating_widget_view, this);
    }
    ...
    public static FloatingWidgetView getFloatingWidgetView(Launcher launcher,
        ...
        FloatingWidgetView floatingView =
                launcher.getViewCache().getView(com.android.launcher3.res.R.layout.floating_widget_view, launcher, parent);
