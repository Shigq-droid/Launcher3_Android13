...
public class TaskView extends FrameLayout implements Reusable {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.addAction(
                new AccessibilityNodeInfo.AccessibilityAction(com.android.launcher3.res.R.string.accessibility_close,
                        getContext().getText(com.android.launcher3.res.R.string.accessibility_close)));
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        if (action == com.android.launcher3.res.R.string.accessibility_close) {
    ...
    private void notifyTaskLaunchFailed(String tag) {
        ...
        Log.w(tag, msg);
        Toast.makeText(getContext(), com.android.launcher3.res.R.string.activity_not_available, LENGTH_SHORT).show();
    }
    ...
    public class TaskIdAttributeContainer {
        ...
        public TaskIdAttributeContainer(Task task, TaskThumbnailView thumbnailView,
            ...
            this.mA11yNodeId = (stagePosition == STAGE_POSITION_BOTTOM_OR_RIGHT) ?
                    com.android.launcher3.res.R.id.split_bottomRight_appInfo : com.android.launcher3.res.R.id.split_topLeft_appInfo;
        }
