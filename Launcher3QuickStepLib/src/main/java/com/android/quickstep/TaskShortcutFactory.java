...
public interface TaskShortcutFactory {
    ...
    /** @Deprecated */
    TaskShortcutFactory SPLIT_SCREEN = new MultiWindowFactory(com.android.launcher3.res.R.drawable.ic_split_screen,
            com.android.launcher3.res.R.string.recent_task_option_split_screen, LAUNCHER_SYSTEM_SHORTCUT_SPLIT_SCREEN_TAP) {
    ...
    TaskShortcutFactory FREE_FORM = new MultiWindowFactory(com.android.launcher3.res.R.drawable.ic_split_screen,
    ...
    class PinSystemShortcut extends SystemShortcut<BaseDraggingActivity> {
        ...
        public PinSystemShortcut(BaseDraggingActivity target,
                TaskIdAttributeContainer taskContainer) {
            super(com.android.launcher3.res.R.drawable.ic_pin, R.string.recent_task_option_pin, target,
