...
public class SettingsChangeLogger implements
    ...
    private static ArrayMap<String, LoggablePref> loadPrefKeys(Context context) {
        XmlPullParser parser = context.getResources().getXml(com.android.launcher3.res.R.xml.launcher_preferences);
            ...
            while (((type = parser.next()) != XmlPullParser.END_TAG
                ...
                if (BOOLEAN_PREF.equals(parser.getName())) {
                    TypedArray a = context.obtainStyledAttributes(
                            Xml.asAttributeSet(parser), com.android.launcher3.res.R.styleable.LoggablePref);
                    String key = a.getString(com.android.launcher3.res.R.styleable.LoggablePref_android_key);
                    LoggablePref pref = new LoggablePref();
                    pref.defaultValue =
                            a.getBoolean(com.android.launcher3.res.R.styleable.LoggablePref_android_defaultValue, true);
                    pref.eventIdOn = a.getInt(com.android.launcher3.res.R.styleable.LoggablePref_logIdOn, 0);
                    pref.eventIdOff = a.getInt(com.android.launcher3.res.R.styleable.LoggablePref_logIdOff, 0);
