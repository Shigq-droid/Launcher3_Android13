...
public class StaggeredWorkspaceAnim {
    ...
    public StaggeredWorkspaceAnim(Launcher launcher, float velocity, boolean animateOverviewScrim,
        ...
        mSpringTransY = transFactor * launcher.getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.swipe_up_max_workspace_trans_y);
    ...
    private void addStaggeredAnimationForView(View v, int row, int totalRows) {
        ...
        float stiffness = rp.getFloat(com.android.launcher3.res.R.dimen.staggered_stiffness);
        float damping = rp.getFloat(com.android.launcher3.res.R.dimen.staggered_damping_ratio);
        float endTransY = 0;
