...
public class RectFSpringAnim extends ReleaseCheck {
    ...
    public RectFSpringAnim(RectF startRect, RectF targetRect, Context context,
        ...
        mMinVisChange = rp.getDimension(com.android.launcher3.res.R.dimen.swipe_up_fling_min_visible_change);
        mMaxVelocityPxPerS = (int) rp.getDimension(com.android.launcher3.res.R.dimen.swipe_up_max_velocity);
        setCanRelease(true);
    ...
    public void start(Context context, PointF velocityPxPerMs) {
        ...
        ResourceProvider rp = DynamicResource.provider(context);
        float damping = rp.getFloat(com.android.launcher3.res.R.dimen.swipe_up_rect_scale_damping_ratio);
        float stiffness = rp.getFloat(com.android.launcher3.res.R.dimen.swipe_up_rect_scale_stiffness);
