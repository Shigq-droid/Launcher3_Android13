...
public class DeviceProfile {
    ...
    DeviceProfile(Context context, InvariantDeviceProfile inv, Info info, WindowBounds windowBounds,
        ...
        mQsbCenterFactor = res.getFloat(com.android.launcher3.res.R.dimen.qsb_center_factor);
        ...
        edgeMarginPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_edge_margin);

        desiredWorkspaceHorizontalMarginPx = getHorizontalMarginPx(inv, res);
        desiredWorkspaceHorizontalMarginOriginalPx = desiredWorkspaceHorizontalMarginPx;
        gridVisualizationPaddingX = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.grid_visualization_horizontal_cell_spacing);
        gridVisualizationPaddingY = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.grid_visualization_vertical_cell_spacing);

        bottomSheetTopPadding = mInsets.top // statusbar height
                + res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.bottom_sheet_extra_top_padding)
                + (isTablet ? 0 : edgeMarginPx); // phones need edgeMarginPx additional padding

        allAppsTopPadding = isTablet ? bottomSheetTopPadding : 0;
        allAppsShiftRange = isTablet
                ? heightPx - allAppsTopPadding
                : res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_starting_vertical_translate);
        folderLabelTextScale = res.getFloat(com.android.launcher3.res.R.dimen.folder_label_text_scale);
        folderContentPaddingLeftRight =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_content_padding_left_right);
        folderContentPaddingTop = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_content_padding_top);
        ...
        workspacePageIndicatorHeight = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.workspace_page_indicator_height);
        mWorkspacePageIndicatorOverlapWorkspace =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.workspace_page_indicator_overlap_workspace);

        iconDrawablePaddingOriginalPx =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_icon_drawable_padding);

        dropTargetBarSizePx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_drop_target_size);
        dropTargetBarTopMarginPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_top_margin);
        dropTargetBarBottomMarginPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_bottom_margin);
        dropTargetDragPaddingPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_drag_padding);
        dropTargetTextSizePx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_text_size);
        dropTargetHorizontalPaddingPx = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.drop_target_button_drawable_horizontal_padding);
        dropTargetVerticalPaddingPx = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.drop_target_button_drawable_vertical_padding);
        dropTargetGapPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_button_gap);
        dropTargetButtonWorkspaceEdgeGapPx = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.drop_target_button_workspace_edge_gap);

        workspaceSpringLoadedBottomSpace =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_min_spring_loaded_space);
        workspaceSpringLoadedMinNextPageVisiblePx = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.dynamic_grid_spring_loaded_min_next_space_visible);

        workspaceCellPaddingXPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_cell_padding_x);

        hotseatQsbHeight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.qsb_widget_height);
        ...
        hotseatBarTopPaddingPx =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_top_padding);
        if (isQsbInline) {
            hotseatBarBottomPaddingPx = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.inline_qsb_bottom_margin);
        } else {
            hotseatBarBottomPaddingPx = (isTallDevice ? res.getDimensionPixelSize(
                    com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_bottom_tall_padding)
                    : res.getDimensionPixelSize(
                    com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_bottom_non_tall_padding))
                    + res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_bottom_padding);
        }

        springLoadedHotseatBarTopMarginPx = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.spring_loaded_hotseat_top_margin);
        hotseatBarSidePaddingEndPx =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_side_padding);
        // Add a bit of space between nav bar and hotseat in vertical bar layout.
        hotseatBarSidePaddingStartPx = isVerticalBarLayout() ? workspacePageIndicatorHeight : 0;
        hotseatExtraVerticalSize =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_hotseat_extra_vertical_size);
        updateHotseatIconSize(pxFromDp(inv.iconSize[INDEX_DEFAULT], mMetrics));

        qsbBottomMarginOriginalPx = isScalableGrid
                ? res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.scalable_grid_qsb_bottom_margin)
                : 0;
        ...
        int cellLayoutPadding =
                isTwoPanels ? cellLayoutBorderSpacePx.x / 2 : res.getDimensionPixelSize(
                        com.android.launcher3.res.R.dimen.cell_layout_padding);
        ...
        flingToDeleteThresholdVelocity = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.drag_flingToDeleteMinVelocity);
    ...
    private int getHorizontalMarginPx(InvariantDeviceProfile idp, Resources res) {
        ...
        return isScalableGrid
                ...
                : res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_left_right_margin);
    }
    ...
    private void updateAllAppsContainerWidth(Resources res) {
        ...
        if (isTablet) {
            allAppsLeftRightPadding =
                    res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_bottom_sheet_horizontal_padding);
    ...
    private void updateAllAppsIconSize(float scale, Resources res) {
        ...
        if (isScalableGrid) {
            ...
            allAppsIconDrawablePaddingPx =
                    res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_icon_drawable_padding);
        }
    ...
    private void updateAvailableFolderCellDimensions(Resources res) {
        ...
        final int folderBottomPanelSize = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_label_height);
    ...
    private void updateFolderCellSize(float scale, Resources res) {
        ...
        if (isScalableGrid) {
            ...
            int cellPaddingX = (int) (res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_cell_x_padding)
                    * scale);
            int cellPaddingY = (int) (res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_cell_y_padding)
                    * scale);
