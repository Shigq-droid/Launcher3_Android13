    ...
    public Bundle call(String method, String arg, @Nullable Bundle extra) {
        ...
        switch (method) {
            ...
            case TestProtocol.REQUEST_START_DRAG_THRESHOLD: {
                ...
                response.putInt(TestProtocol.TEST_INFO_RESPONSE_FIELD,
                        resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.deep_shortcuts_start_drag_threshold)
                                + resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.pre_drag_view_scale));
                return response;
            }
