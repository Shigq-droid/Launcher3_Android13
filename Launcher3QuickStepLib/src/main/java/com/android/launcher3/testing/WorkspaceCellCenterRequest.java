...
public class WorkspaceCellCenterRequest implements TestInformationRequest {
    ...
    public static final Creator<WorkspaceCellCenterRequest> CREATOR =
            new Creator<WorkspaceCellCenterRequest>() {
