...
public abstract class FastScrollRecyclerView extends RecyclerView  {
    ...
    public void bindFastScrollbar() {
        ...
        mScrollbar = parent.findViewById(com.android.launcher3.res.R.id.fast_scroller);
        mScrollbar.setRecyclerView(this, parent.findViewById(com.android.launcher3.res.R.id.fast_scroller_popup));
        onUpdateScrollbar(0);
    }
