...
public class AddItemWidgetsBottomSheet extends AbstractSlideInView<AddItemActivity> implements
    ...
    protected void onFinishInflate() {
        ...
        mContent = findViewById(com.android.launcher3.res.R.id.add_item_bottom_sheet_content);
        mWidgetPreviewScrollView = findViewById(com.android.launcher3.res.R.id.widget_preview_scroll_view);
    }
    ...
    public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        if (contentHorizontalMarginInPx != mContentHorizontalMarginInPx) {
            setContentHorizontalMargin(findViewById(com.android.launcher3.res.R.id.widget_appName),
                    contentHorizontalMarginInPx);
            setContentHorizontalMargin(findViewById(com.android.launcher3.res.R.id.widget_drag_instruction),
                    contentHorizontalMarginInPx);
            setContentHorizontalMargin(findViewById(com.android.launcher3.res.R.id.widget_cell), contentHorizontalMarginInPx);
            setContentHorizontalMargin(findViewById(com.android.launcher3.res.R.id.actions_container),
                    contentHorizontalMarginInPx);
