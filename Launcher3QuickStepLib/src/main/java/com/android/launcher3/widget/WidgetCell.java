...
public class WidgetCell extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mWidgetImageContainer = findViewById(com.android.launcher3.res.R.id.widget_preview_container);
        mWidgetImage = findViewById(com.android.launcher3.res.R.id.widget_preview);
        mWidgetBadge = findViewById(com.android.launcher3.res.R.id.widget_badge);
        mWidgetName = findViewById(com.android.launcher3.res.R.id.widget_name);
        mWidgetDims = findViewById(com.android.launcher3.res.R.id.widget_dims);
        mWidgetDescription = findViewById(com.android.launcher3.res.R.id.widget_description);
    }
    ...
    public void applyFromCellItem(WidgetItem item, float previewScale,
        ...
        mWidgetName.setContentDescription(
                context.getString(com.android.launcher3.res.R.string.widget_preview_context_description, mItem.label));
        mWidgetDims.setText(context.getString(com.android.launcher3.res.R.string.widget_dims_format,
                mItem.spanX, mItem.spanY));
        mWidgetDims.setContentDescription(context.getString(
                com.android.launcher3.res.R.string.widget_accessible_dims_format, mItem.spanX, mItem.spanY));
    ...
    public void showBadge() {
        if (Process.myUserHandle().equals(mItem.user)) {
            ...
            mWidgetBadge.setImageResource(com.android.launcher3.iconloader.R.drawable.ic_work_app_badge);
        }
    }
