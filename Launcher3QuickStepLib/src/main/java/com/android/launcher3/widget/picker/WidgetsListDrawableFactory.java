...
final class WidgetsListDrawableFactory {
    ...
    WidgetsListDrawableFactory(Context context) {
        ...
        mTopBottomCornerRadius = res.getDimension(com.android.launcher3.res.R.dimen.widget_list_top_bottom_corner_radius);
        mMiddleCornerRadius = res.getDimension(com.android.launcher3.res.R.dimen.widget_list_content_corner_radius);
        mSurfaceColor = context.getColorStateList(com.android.launcher3.res.R.color.surface);
