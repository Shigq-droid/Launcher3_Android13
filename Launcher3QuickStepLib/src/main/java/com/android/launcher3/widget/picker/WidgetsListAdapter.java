...
public class WidgetsListAdapter extends Adapter<ViewHolder> implements OnHeaderClickListener {
    ...
    private static final int VIEW_TYPE_WIDGETS_SPACE = com.android.launcher3.res.R.id.view_type_widgets_space;
    private static final int VIEW_TYPE_WIDGETS_LIST = com.android.launcher3.res.R.id.view_type_widgets_list;
    private static final int VIEW_TYPE_WIDGETS_HEADER = com.android.launcher3.res.R.id.view_type_widgets_header;
    private static final int VIEW_TYPE_WIDGETS_SEARCH_HEADER = com.android.launcher3.res.R.id.view_type_widgets_search_header;
    ...
    public WidgetsListAdapter(Context context, LayoutInflater layoutInflater,
        ...
        mSpacingBetweenEntries =
                context.getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_list_entry_spacing);
    }
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        mRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(
                ...
                boolean isHeader =
                        view.getTag(com.android.launcher3.res.R.id.tag_widget_entry) instanceof WidgetsListBaseEntry.Header;
    ...
    public void onBindViewHolder(ViewHolder holder, int pos, List<Object> payloads) {
        ...
        holder.itemView.setTag(com.android.launcher3.res.R.id.tag_widget_entry, entry);
    }
