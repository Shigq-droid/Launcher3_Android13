...
public class WidgetsRecyclerView extends FastScrollRecyclerView implements OnItemTouchListener {
    ...
    public WidgetsRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrollbarTop = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.dynamic_grid_edge_margin);
        ...
        mSpacingBetweenEntries =
                getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_list_entry_spacing);
    }
