...
public class WidgetsBottomSheet extends BaseWidgetSheet {
    ...
    private final Runnable mShowEducationTipTask = () -> {
        ...
        View viewForTip = ((ViewGroup) ((TableLayout) findViewById(com.android.launcher3.res.R.id.widgets_table))
    ...
    protected void onFinishInflate() {
        ...
        mContent = findViewById(com.android.launcher3.res.R.id.widgets_bottom_sheet);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        ScrollView widgetsTableScrollView = findViewById(com.android.launcher3.res.R.id.widgets_table_scroll_view);
        TableLayout widgetsTable = findViewById(com.android.launcher3.res.R.id.widgets_table);
        if (widgetsTable.getMeasuredHeight() > widgetsTableScrollView.getMeasuredHeight()) {
            findViewById(com.android.launcher3.res.R.id.collapse_handle).setVisibility(VISIBLE);
        }
    }

    public void populateAndShow(ItemInfo itemInfo) {
        mOriginalItemInfo = itemInfo;
        ((TextView) findViewById(com.android.launcher3.res.R.id.title)).setText(mOriginalItemInfo.title);
    ...
    public boolean onControllerInterceptTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            mNoIntercept = false;
            ScrollView scrollView = findViewById(com.android.launcher3.res.R.id.widgets_table_scroll_view);
    ...
    protected WidgetCell addItemCell(ViewGroup parent) {
        WidgetCell widget = (WidgetCell) LayoutInflater.from(getContext())
                .inflate(com.android.launcher3.res.R.layout.widget_cell, parent, false);

        View previewContainer = widget.findViewById(com.android.launcher3.res.R.id.widget_preview_container);
    ...
    protected void onContentHorizontalMarginChanged(int contentHorizontalMarginInPx) {
        MarginLayoutParams layoutParams =
                ((MarginLayoutParams) findViewById(com.android.launcher3.res.R.id.widgets_table).getLayoutParams());
    ...
    protected Pair<View, String> getAccessibilityTarget() {
        return Pair.create(findViewById(com.android.launcher3.res.R.id.title),  getContext().getString(
