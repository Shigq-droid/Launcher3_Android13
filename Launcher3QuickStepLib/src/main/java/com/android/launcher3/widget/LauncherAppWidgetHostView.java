...
public class LauncherAppWidgetHostView extends BaseLauncherAppWidgetHostView
    ...
    public LauncherAppWidgetHostView(Context context) {
        ...
        setBackgroundResource(com.android.launcher3.res.R.drawable.widget_internal_focus_bg);

        if (Utilities.ATLEAST_Q && Themes.getAttrBoolean(mLauncher, com.android.launcher3.res.R.attr.isWorkspaceDarkText)) {
