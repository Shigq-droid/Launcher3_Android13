    ...
    public WidgetsRowViewHolder newViewHolder(ViewGroup parent) {
        ...
        WidgetsRowViewHolder viewHolder =
                new WidgetsRowViewHolder(mLayoutInflater.inflate(
                        com.android.launcher3.res.R.layout.widgets_table_container, parent, false));
            ...
            if (tableRow.getChildCount() > widgetItems.size()) {
                ...
                for (int j = tableRow.getChildCount(); j < widgetItems.size(); j++) {
                    WidgetCell widget = (WidgetCell) mLayoutInflater.inflate(
                            com.android.launcher3.res.R.layout.widget_cell, tableRow, false);
                    // set up touch.
                    View preview = widget.findViewById(com.android.launcher3.res.R.id.widget_preview_container);
