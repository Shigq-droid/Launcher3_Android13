...
public final class WidgetsRecommendationTableLayout extends TableLayout {
    ...
    public WidgetsRecommendationTableLayout(Context context, AttributeSet attrs) {
        ...
        mWidgetsRecommendationTableVerticalPadding = 2 * getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.recommended_widgets_table_vertical_padding);
        mWidgetCellVerticalPadding = 2 * getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_cell_vertical_padding);
        mWidgetCellTextViewsHeight = 4 * getResources().getDimension(com.android.launcher3.res.R.dimen.widget_cell_font_size);
    }
    ...
    private WidgetCell addItemCell(ViewGroup parent) {
        WidgetCell widget = (WidgetCell) LayoutInflater.from(
                getContext()).inflate(com.android.launcher3.res.R.layout.widget_cell, parent, false);
