...
public class DatabaseWidgetPreviewLoader {
    ...
    public DatabaseWidgetPreviewLoader(Context context) {
        ...
        mPreviewBoxCornerRadius = previewCornerRadius > 0
                ? previewCornerRadius
                : mContext.getResources().getDimension(com.android.launcher3.res.R.dimen.widget_preview_corner_radius);
    }
        ...
        return BitmapRenderer.createHardwareBitmap(previewWidth, previewHeight, c -> {
            ...
            if (widgetPreviewExists) {
                ...
                p.setStrokeWidth(mContext.getResources()
                        .getDimension(com.android.launcher3.res.R.dimen.widget_preview_cell_divider_width));
    ...
    private RectF drawBoxWithShadow(Canvas c, int width, int height) {
        ...
        builder.shadowBlur = res.getDimension(com.android.launcher3.res.R.dimen.widget_preview_shadow_blur);
        builder.radius = mPreviewBoxCornerRadius;
        builder.keyShadowDistance = res.getDimension(com.android.launcher3.res.R.dimen.widget_preview_key_shadow_distance);
    ...
    private Bitmap generateShortcutPreview(
        ...
        int padding = mContext.getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_preview_shortcut_padding);
