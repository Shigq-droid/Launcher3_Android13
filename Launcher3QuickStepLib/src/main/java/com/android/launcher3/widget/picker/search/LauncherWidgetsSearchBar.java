...
public class LauncherWidgetsSearchBar extends LinearLayout implements WidgetsSearchBar {
    ...
    protected void onFinishInflate() {
        ...
        mEditText = findViewById(com.android.launcher3.res.R.id.widgets_search_bar_edit_text);
        mCancelButton = findViewById(com.android.launcher3.res.R.id.widgets_search_cancel_button);
    }
