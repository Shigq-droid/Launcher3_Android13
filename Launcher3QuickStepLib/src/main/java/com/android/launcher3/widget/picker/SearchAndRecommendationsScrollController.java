...
final class SearchAndRecommendationsScrollController implements
    ...
    SearchAndRecommendationsScrollController(
        ...
        mSearchBarContainer = mContainer.findViewById(com.android.launcher3.res.R.id.search_bar_container);
        mSearchBar = mContainer.findViewById(com.android.launcher3.res.R.id.widgets_search_bar);
        mHeaderTitle = mContainer.findViewById(com.android.launcher3.res.R.id.title);
        mRecommendedWidgetsTable = mContainer.findViewById(com.android.launcher3.res.R.id.recommended_widget_table);
        mTabBar = mContainer.findViewById(com.android.launcher3.res.R.id.tabs);
