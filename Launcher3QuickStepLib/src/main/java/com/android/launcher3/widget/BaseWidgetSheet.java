...
public abstract class BaseWidgetSheet extends AbstractSlideInView<Launcher>
    ...
    public BaseWidgetSheet(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContentHorizontalMarginInPx = getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.widget_list_horizontal_margin);
    ...
    protected int getScrimColor(Context context) {
        return context.getResources().getColor(com.android.launcher3.res.R.color.widgets_picker_scrim);
    }
    ...
    protected void setupNavBarColor() {
        boolean isSheetDark = Themes.getAttrBoolean(getContext(), com.android.launcher3.res.R.attr.isMainColorDark);
        getSystemUiController().updateUiState(
    ...
    public static Toast showWidgetToast(Context context, Toast toast) {
        ...
        CharSequence msg = Utilities.wrapForTts(
                context.getText(com.android.launcher3.res.R.string.long_press_widget_to_add),
                context.getString(com.android.launcher3.res.R.string.long_accessible_way_to_add));
    ...
    private static Toast showShortcutToast(Context context, Toast toast) {
        ...
        CharSequence msg = Utilities.wrapForTts(
                context.getText(com.android.launcher3.res.R.string.long_press_shortcut_to_add),
                context.getString(com.android.launcher3.res.R.string.long_accessible_way_to_add_shortcut));
        toast = Toast.makeText(context, msg, Toast.LENGTH_SHORT);
        toast.show();
        return toast;
    }
    ...
    protected ArrowTipView showEducationTipOnViewIfPossible(@Nullable View view) {
        ...
        ArrowTipView arrowTipView =
                new ArrowTipView(mActivityContext,  /* isPointingUp= */ false).showAtLocation(
                        getContext().getString(com.android.launcher3.res.R.string.long_press_widget_to_add),
