...
public class PendingAppWidgetHostView extends LauncherAppWidgetHostView
    ...
    public PendingAppWidgetHostView(Context context, LauncherAppWidgetInfo info,
        ...
        super(new ContextThemeWrapper(context, com.android.launcher3.res.R.style.WidgetContainerTheme));
        ...
        setBackgroundResource(com.android.launcher3.res.R.drawable.pending_widget_bg);
    ...
    protected View getDefaultView() {
        View defaultView = mInflater.inflate(com.android.launcher3.res.R.layout.appwidget_not_ready, this, false);
        ...
        if (info.bitmap.icon != null) {
            ...
            if (mDisabledForSafeMode) {
                ...
                mCenterDrawable = widgetCategoryIcon == null
                        ...
                        : widgetCategoryIcon;
                mSettingIconDrawable = getResources().getDrawable(com.android.launcher3.res.R.drawable.ic_setting).mutate();
    ...
    private void updateDrawableBounds() {
        ...
        int minPadding = getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.pending_widget_min_padding);
        ...
        if (mSettingIconDrawable == null) {
            ...
            if (availableWidth > 0) {
                ...
                mSetupTextLayout = new StaticLayout(
                        getResources().getText(com.android.launcher3.res.R.string.gadget_complete_setup_text), mPaint,
