...
public final class WidgetSections {
    ...
    private static synchronized void parseWidgetSectionsXml(Context context) {
        ...
        try (XmlResourceParser parser = context.getResources().getXml(com.android.launcher3.res.R.xml.widget_sections)) {
                    ...
                    while (((type = parser.next()) != XmlPullParser.END_TAG
                        ...
                        if ((type == XmlPullParser.START_TAG)
                            ...
                            TypedArray a = context.obtainStyledAttributes(
                                    Xml.asAttributeSet(parser), com.android.launcher3.res.R.styleable.WidgetSections);
                            ComponentName provider = ComponentName.unflattenFromString(
                                    a.getString(com.android.launcher3.res.R.styleable.WidgetSections_provider));
                            boolean alsoKeepInApp = a.getBoolean(
                                    com.android.launcher3.res.R.styleable.WidgetSections_alsoKeepInApp,
                                    /* defValue= */ false);
    ...
    public static final class WidgetSection {
        ...
        public WidgetSection(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.android.launcher3.res.R.styleable.WidgetSections);
            mCategory = a.getInt(com.android.launcher3.res.R.styleable.WidgetSections_category, NO_CATEGORY);
            mSectionTitle = a.getResourceId(com.android.launcher3.res.R.styleable.WidgetSections_sectionTitle, ID_NULL);
            mSectionDrawable = a.getResourceId(com.android.launcher3.res.R.styleable.WidgetSections_sectionDrawable, ID_NULL);
        }
    }
}
