...
public final class WidgetsListHeader extends LinearLayout implements ItemInfoUpdateReceiver {
    ...
    public WidgetsListHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.android.launcher3.res.R.styleable.WidgetsListRowHeader, defStyleAttr, /* defStyleRes= */ 0);
        mIconSize = a.getDimensionPixelSize(com.android.launcher3.res.R.styleable.WidgetsListRowHeader_appIconSize,
                grid.iconSizePx);
    }
    ...
    protected void onFinishInflate() {
        ...
        mAppIcon = findViewById(com.android.launcher3.res.R.id.app_icon);
        mTitle = findViewById(com.android.launcher3.res.R.id.app_title);
        mSubtitle = findViewById(com.android.launcher3.res.R.id.app_subtitle);
        mExpandToggle = findViewById(com.android.launcher3.res.R.id.toggle);
    ...
    private void setTitles(WidgetsListHeaderEntry entry) {
        ...
        if (entry.widgetsCount > 0 && entry.shortcutsCount > 0) {
            String widgetsCount = PluralMessageFormat.getIcuPluralString(getContext(),
                    com.android.launcher3.res.R.string.widgets_count, entry.widgetsCount);
            String shortcutsCount = PluralMessageFormat.getIcuPluralString(getContext(),
                    com.android.launcher3.res.R.string.shortcuts_count, entry.shortcutsCount);
            subtitle = resources.getString(com.android.launcher3.res.R.string.widgets_and_shortcuts_count, widgetsCount,
                    shortcutsCount);
