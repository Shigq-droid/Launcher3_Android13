...
public class WidgetsFullSheet extends BaseWidgetSheet
    ...
    public WidgetsFullSheet(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabsHeight = mHasWorkProfile
                ? resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_header_pill_height)
                : 0;
        mWidgetSheetContentHorizontalPadding = 2 * resources.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.widget_cell_horizontal_padding);
    ...
    protected void onFinishInflate() {
        ...
        mContent = findViewById(com.android.launcher3.res.R.id.container);

        LayoutInflater layoutInflater = LayoutInflater.from(getContext());
        int contentLayoutRes = mHasWorkProfile ? com.android.launcher3.res.R.layout.widgets_full_sheet_paged_view
                : com.android.launcher3.res.R.layout.widgets_full_sheet_recyclerview;
        layoutInflater.inflate(contentLayoutRes, mContent, true);

        RecyclerViewFastScroller fastScroller = findViewById(com.android.launcher3.res.R.id.fast_scroller);
        mAdapters.get(AdapterHolder.PRIMARY).setup(findViewById(com.android.launcher3.res.R.id.primary_widgets_list_view));
        mAdapters.get(AdapterHolder.SEARCH).setup(findViewById(com.android.launcher3.res.R.id.search_widgets_list_view));
        if (mHasWorkProfile) {
            mViewPager = findViewById(com.android.launcher3.res.R.id.widgets_view_pager);
            ...
            mAdapters.get(AdapterHolder.WORK).setup(findViewById(com.android.launcher3.res.R.id.work_widgets_list_view));
            setDeviceManagementResources();
        } else {
            mViewPager = null;
        }

        mNoWidgetsView = findViewById(com.android.launcher3.res.R.id.no_widgets_text);
        mSearchScrollController = new SearchAndRecommendationsScrollController(
                findViewById(com.android.launcher3.res.R.id.search_and_recommendations_container));
        mSearchScrollController.setCurrentRecyclerView(
                findViewById(com.android.launcher3.res.R.id.primary_widgets_list_view));
    ...
    private void updateRecyclerViewVisibility(AdapterHolder adapterHolder) {
        ...
        if (adapterHolder.mAdapterType == AdapterHolder.SEARCH) {
            mNoWidgetsView.setText(com.android.launcher3.res.R.string.no_search_results);
            ...
            mNoWidgetsView.setText(com.android.launcher3.res.R.string.no_widgets_available);
        }
    ...
    protected Pair<View, String> getAccessibilityTarget() {
        return Pair.create(getRecyclerView(), getContext().getString(
                mIsOpen ? com.android.launcher3.res.R.string.widgets_list : com.android.launcher3.res.R.string.widgets_list_closed));
    }
    ...
    public static WidgetsFullSheet show(Launcher launcher, boolean animate) {
        WidgetsFullSheet sheet = (WidgetsFullSheet) launcher.getLayoutInflater()
                .inflate(com.android.launcher3.res.R.layout.widgets_full_sheet, launcher.getDragLayer(), false);
    ...
    public static WidgetsRecyclerView getWidgetsView(Launcher launcher) {
        return launcher.findViewById(com.android.launcher3.res.R.id.primary_widgets_list_view);
    }
