...
public class Launcher extends StatefulActivity<LauncherState>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inflateRootView(com.android.launcher3.res.R.layout.launcher);
        setupViews();
        ...
        getSystemUiController().updateUiState(SystemUiController.UI_STATE_BASE_WINDOW,
                Themes.getAttrBoolean(this, com.android.launcher3.res.R.attr.isWorkspaceDarkText));
        ...
        setTitle(com.android.launcher3.res.R.string.home_screen);
    }
    ...
    private int completeAdd(
        ...
        switch (requestCode) {
            case REQUEST_CREATE_SHORTCUT:
                ...
                announceForAccessibility(com.android.launcher3.res.R.string.item_added_to_workspace);
                break;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == REQUEST_PERMISSION_CALL_PHONE && pendingArgs != null
            ...
            if (grantResults.length > 0
                ...
                Toast.makeText(this, getString(com.android.launcher3.res.R.string.msg_no_phone_permission,
    ...
    private void logStopAndResume(boolean isResume) {
        ...
        if (statsLogOrdinal == LAUNCHER_STATE_HOME && mWorkspace != null) {
            logger.withContainerInfo(ContainerInfo.newBuilder()
                    .setWorkspace(
                            WorkspaceContainer.newBuilder()
    ...
    protected void setupViews() {
        mDragLayer = findViewById(com.android.launcher3.res.R.id.drag_layer);
        mFocusHandler = mDragLayer.getFocusIndicatorHelper();
        mWorkspace = mDragLayer.findViewById(com.android.launcher3.res.R.id.workspace);
        mWorkspace.initParentViews(mDragLayer);
        mOverviewPanel = findViewById(com.android.launcher3.res.R.id.overview_panel);
        mHotseat = findViewById(com.android.launcher3.res.R.id.hotseat);
        ...
        mDropTargetBar = mDragLayer.findViewById(com.android.launcher3.res.R.id.drop_target_bar);

        // Setup Apps
        mAppsView = findViewById(com.android.launcher3.res.R.id.apps_view);

        // Setup Scrim
        mScrimView = findViewById(com.android.launcher3.res.R.id.scrim_view);
    ...
    public View createShortcut(ViewGroup parent, WorkspaceItemInfo info) {
        BubbleTextView favorite = (BubbleTextView) LayoutInflater.from(parent.getContext())
                .inflate(com.android.launcher3.res.R.layout.app_icon, parent, false);
    ...
    public FolderIcon addFolder(CellLayout layout, int container, final int screenId, int cellX,
        ...
        // Create the view
        FolderIcon newFolder = FolderIcon.inflateFolderAndIcon(com.android.launcher3.res.R.layout.folder_icon, this, layout,
                folderInfo);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        text.add(mWorkspace == null
                ? getString(com.android.launcher3.res.R.string.home_screen)
        ...
        for (int i = 0; i < end; i++) {
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_FOLDER: {
                    view = FolderIcon.inflateFolderAndIcon(com.android.launcher3.res.R.layout.folder_icon, this,
    ...
    public void finishBindingItems(IntSet pagesBoundFirst) {
        ...
        getViewCache().setCacheSize(com.android.launcher3.res.R.layout.folder_application,
                mDeviceProfile.inv.numFolderColumns * mDeviceProfile.inv.numFolderRows);
        getViewCache().setCacheSize(com.android.launcher3.res.R.layout.folder_page, 2);
    ...
    public void onProvideKeyboardShortcuts(
        ...
        if (isInState(NORMAL)) {
            shortcutInfos.add(new KeyboardShortcutInfo(getString(com.android.launcher3.res.R.string.all_apps_button_label),
                    KeyEvent.KEYCODE_A, KeyEvent.META_CTRL_ON));
            shortcutInfos.add(new KeyboardShortcutInfo(getString(com.android.launcher3.res.R.string.widget_button_text),
        ...
        if (!shortcutInfos.isEmpty()) {
            data.add(new KeyboardShortcutGroup(getString(com.android.launcher3.res.R.string.home_screen), shortcutInfos));
        }
    ...
    protected RectF getPopupTarget(float x, float y) {
        float halfSize = getResources().getDimension(com.android.launcher3.res.R.dimen.options_menu_thumb_size) / 2;
        if (x < 0 || y < 0) {
    ...
    public ArrowPopup<?> getOptionsPopup() {
        return findViewById(com.android.launcher3.res.R.id.popup_container);
    }
