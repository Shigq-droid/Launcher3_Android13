...
public class AppWidgetResizeFrame extends AbstractFloatingView implements View.OnKeyListener {
    ...
    public AppWidgetResizeFrame(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundPadding = getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.resize_frame_background_padding);
        ...
        mDragAcrossTwoPanelOpacityMargin = mLauncher.getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.resize_frame_invalid_drag_across_two_panel_opacity_margin);
    ...
    protected void onFinishInflate() {
        ...
        mDragHandles[INDEX_LEFT] = findViewById(com.android.launcher3.res.R.id.widget_resize_left_handle);
        mDragHandles[INDEX_TOP] = findViewById(com.android.launcher3.res.R.id.widget_resize_top_handle);
        mDragHandles[INDEX_RIGHT] = findViewById(com.android.launcher3.res.R.id.widget_resize_right_handle);
        mDragHandles[INDEX_BOTTOM] = findViewById(com.android.launcher3.res.R.id.widget_resize_bottom_handle);
    }
    ...
    public static void showForWidget(LauncherAppWidgetHostView widget, CellLayout cellLayout) {
        ...
        AppWidgetResizeFrame frame = (AppWidgetResizeFrame) launcher.getLayoutInflater()
                .inflate(com.android.launcher3.res.R.layout.app_widget_resize_frame, dl, false);
        if (widget.hasEnforcedCornerRadius()) {
            float enforcedCornerRadius = widget.getEnforcedCornerRadius();
            ImageView imageView = frame.findViewById(com.android.launcher3.res.R.id.widget_resize_frame);
    ...
    private void setupForWidget(LauncherAppWidgetHostView widgetView, CellLayout cellLayout,
        ...
        mReconfigureButton = (ImageButton) findViewById(com.android.launcher3.res.R.id.widget_reconfigure_button);
    ...
    public void visualizeResizeForDelta(int deltaX, int deltaY) {
        ...
        if (mCellLayout.getParent() instanceof Workspace) {
            ...
            if (pairedCellLayout != null) {
                ...
                findViewById(com.android.launcher3.res.R.id.widget_resize_frame).getGlobalVisibleRect(resizeFrameBound);
                float progress = 1f;
        ...
        if (mCellLayout.createAreaForResize(cellX, cellY, spanX, spanY, mWidgetView,
            ...
            if (mStateAnnouncer != null && (lp.cellHSpan != spanX || lp.cellVSpan != spanY) ) {
                mStateAnnouncer.announce(
                        mLauncher.getString(com.android.launcher3.res.R.string.widget_resized, spanX, spanY));
            }
    ...
    @Nullable private ArrowTipView showReconfigurableWidgetEducationTip() {
        ...
        @Px int tipMargin = mLauncher.getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_reconfigure_tip_top_margin);
        return new ArrowTipView(mLauncher, /* isPointingUp= */ true)
                .showAroundRect(
                        getContext().getString(com.android.launcher3.res.R.string.reconfigurable_widget_education_tip),
