...
public class FolderPagedView extends PagedView<PageIndicatorDots> implements ClipPathView {
    ...
    public void setFolder(Folder folder) {
        mFolder = folder;
        mPageIndicator = folder.findViewById(com.android.launcher3.res.R.id.folder_page_indicator);
    ...
    public void unbindItems() {
        for (int i = getChildCount() - 1; i >= 0; i--) {
            ...
            for (int j = container.getChildCount() - 1; j >= 0; j--) {
                ...
                mViewCache.recycleView(com.android.launcher3.res.R.layout.folder_application, container.getChildAt(j));
            }
            page.removeAllViews();
            mViewCache.recycleView(com.android.launcher3.res.R.layout.folder_page, page);
        }
        removeAllViews();
        mViewsBound = false;
    }
    ...
    public View createNewView(WorkspaceItemInfo item) {
        ...
        final BubbleTextView textView = mViewCache.getView(
                com.android.launcher3.res.R.layout.folder_application, getContext(), null);
    ...
    private CellLayout createAndAddNewPage() {
        ...
        CellLayout page = mViewCache.getView(com.android.launcher3.res.R.layout.folder_page, getContext(), this);
    ...
    public String getAccessibilityDescription() {
        return getContext().getString(com.android.launcher3.res.R.string.folder_opened, mGridCountX, mGridCountY);
    }
