...
public class FolderAnimationManager {
    ...
    public FolderAnimationManager(Folder folder, boolean isOpening) {
        ...
        mDuration = res.getInteger(com.android.launcher3.res.R.integer.config_materialFolderExpandDuration);
        mDelay = res.getInteger(com.android.launcher3.res.R.integer.config_folderDelay);

        mFolderInterpolator = AnimationUtils.loadInterpolator(mContext,
                com.android.launcher3.res.R.interpolator.folder_interpolator);
        mLargeFolderPreviewItemOpenInterpolator = AnimationUtils.loadInterpolator(mContext,
                com.android.launcher3.res.R.interpolator.large_folder_preview_item_open_interpolator);
        mLargeFolderPreviewItemCloseInterpolator = AnimationUtils.loadInterpolator(mContext,
                com.android.launcher3.res.R.interpolator.large_folder_preview_item_close_interpolator);
    }
    ...
    public AnimatorSet getAnimator() {
        ...
        final int initialColor = Themes.getAttrColor(mContext, com.android.launcher3.res.R.attr.folderPreviewColor);
        final int finalColor = Themes.getAttrColor(mContext, com.android.launcher3.res.R.attr.folderBackgroundColor);
