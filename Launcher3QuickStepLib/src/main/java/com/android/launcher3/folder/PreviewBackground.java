...
public class PreviewBackground extends CellLayout.DelegatedCellDrawing {
    ...
    public void setup(Context context, ActivityContext activity, View invalidateDelegate,
        ...
        TypedArray ta = context.getTheme().obtainStyledAttributes(com.android.launcher3.res.R.styleable.FolderIconPreview);
        mDotColor = ta.getColor(com.android.launcher3.res.R.styleable.FolderIconPreview_folderDotColor, 0);
        mStrokeColor = ta.getColor(com.android.launcher3.res.R.styleable.FolderIconPreview_folderIconBorderColor, 0);
        mBgColor = ta.getColor(com.android.launcher3.res.R.styleable.FolderIconPreview_folderPreviewColor, 0);
        ta.recycle();
