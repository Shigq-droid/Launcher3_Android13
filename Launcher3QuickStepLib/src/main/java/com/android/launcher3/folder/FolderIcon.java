...
public class FolderIcon extends FrameLayout implements FolderListener, IconLabelDotView,
    ...
    public static FolderIcon inflateIcon(int resId, ActivityContext activity, ViewGroup group,
        ...
        icon.mFolderName = icon.findViewById(com.android.launcher3.res.R.id.folder_icon_name);
    ...
    public String getAccessiblityTitle(CharSequence title) {
        ...
        if (size < MAX_NUM_ITEMS_IN_PREVIEW) {
            return getContext().getString(com.android.launcher3.res.R.string.folder_name_format_exact, title, size);
        } else {
            return getContext().getString(com.android.launcher3.res.R.string.folder_name_format_overflow, title,
