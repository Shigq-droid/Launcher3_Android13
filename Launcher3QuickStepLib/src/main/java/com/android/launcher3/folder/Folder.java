...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    protected void onFinishInflate() {
        ...
        mBackground = (GradientDrawable) ResourcesCompat.getDrawable(getResources(),
                com.android.launcher3.res.R.drawable.round_rect_folder, getContext().getTheme());

        mContent = findViewById(com.android.launcher3.res.R.id.folder_content);
        mContent.setPadding(paddingLeftRight, dp.folderContentPaddingTop, paddingLeftRight, 0);
        mContent.setFolder(this);

        mPageIndicator = findViewById(com.android.launcher3.res.R.id.folder_page_indicator);
        mFolderName = findViewById(com.android.launcher3.res.R.id.folder_name);
        ...
        mFooter = findViewById(com.android.launcher3.res.R.id.folder_footer);
        mFooterHeight = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.folder_label_height);
    ...
    public boolean onBackKey() {
        ...
        if (TextUtils.isEmpty(mInfo.title)) {
            mFolderName.setHint(com.android.launcher3.res.R.string.folder_hint_text);
            mFolderName.setText("");
        } else {
        ...
        sendCustomAccessibilityEvent(
                ...
                getContext().getString(com.android.launcher3.res.R.string.folder_renamed, newTitle));
    ...
    static <T extends Context & ActivityContext> Folder fromXml(T activityContext) {
        return (Folder) LayoutInflater.from(activityContext).cloneInContext(activityContext)
                .inflate(com.android.launcher3.res.R.layout.user_folder_icon_normalized, null);
    }
    ...
    protected Pair<View, String> getAccessibilityTarget() {
        return Pair.create(mContent, mIsOpen ? mContent.getAccessibilityDescription()
                : getContext().getString(com.android.launcher3.res.R.string.folder_closed));
    }
    ...
    public void onDragOver(DragObject d) {
        ...
        if (mTargetRank != mPrevTargetRank) {
            ...
            if (d.stateAnnouncer != null) {
                d.stateAnnouncer.announce(getContext().getString(com.android.launcher3.res.R.string.move_to_position,
                        mTargetRank + 1));
            }
        }
    ...
    private class OnScrollHintListener implements OnAlarmListener {
        ...
        public void onAlarm(Alarm alarm) {
            ...
            int rescrollDelay = getResources().getInteger(
                    com.android.launcher3.res.R.integer.config_pageSnapAnimationDuration) + RESCROLL_EXTRA_DELAY;
