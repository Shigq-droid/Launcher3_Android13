...
public abstract class ArrowPopup<T extends Context & ActivityContext>
    ...
    private static final int DARK_COLOR_EXTRACTION_INDEX = com.android.launcher3.res.R.color.system_shortcut_text;
    private static final int LIGHT_COLOR_EXTRACTION_INDEX = com.android.launcher3.res.R.color.system_shortcut_text;
    ...
    public ArrowPopup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = Themes.getAttrColor(context, com.android.launcher3.res.R.attr.popupColorPrimary);
        mArrowColor = mBackgroundColor;
        mElevation = getResources().getDimension(com.android.launcher3.res.R.dimen.deep_shortcuts_elevation);

        // Initialize arrow view
        final Resources resources = getResources();
        mMargin = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_margin);
        mArrowWidth = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_arrow_width);
        mArrowHeight = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_arrow_height);
        mArrow = new View(context);
        mArrow.setLayoutParams(new DragLayer.LayoutParams(mArrowWidth, mArrowHeight));
        mArrowOffsetVertical = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_arrow_vertical_offset);
        mArrowOffsetHorizontal = resources.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.popup_arrow_horizontal_center_offset) - (mArrowWidth / 2);
        mArrowPointRadius = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_arrow_corner_radius);

        int smallerRadius = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_smaller_radius);
        ...
        mIterateChildrenTag = getContext().getString(com.android.launcher3.res.R.string.popup_container_iterate_children);
        ...
        if (shouldUseColorExtraction) {
            mColorIds = new int[]{com.android.launcher3.res.R.color.popup_shade_first, com.android.launcher3.res.R.color.popup_shade_second,
                    com.android.launcher3.res.R.color.popup_shade_third};
        } else {
            mColorIds = new int[]{com.android.launcher3.res.R.color.popup_shade_first};
        }
    }
            ...
            if (view.getVisibility() == VISIBLE) {
                ...
                if (isShortcutOrWrapper(view)) {
                    if (totalVisibleShortcuts == 1) {
                        view.setBackgroundResource(com.android.launcher3.res.R.drawable.single_item_primary);
                        ...
                        if (numVisibleShortcut == 0) {
                            ...
                            view.setBackgroundResource(com.android.launcher3.res.R.drawable.middle_item_primary);
                        }
                        numVisibleShortcut++;
                    }
                }
    ...
    private void orientAboutObject(boolean allowAlignLeft, boolean allowAlignRight) {
        ...
        int extraVerticalSpace = mArrowHeight + mArrowOffsetVertical
                + getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_vertical_padding);
