...
public class SecondaryDragLayer extends BaseDragLayer<SecondaryDisplayLauncher> {
    ...
    protected void onFinishInflate() {
        ...
        mAllAppsButton = findViewById(com.android.launcher3.res.R.id.all_apps_button);

        mAppsView = findViewById(R.id.apps_view);
        mAppsView.setOnIconLongClickListener(this::onIconLongClicked);

        // Setup workspace
        mWorkspace = findViewById(com.android.launcher3.res.R.id.workspace_grid);
    ...
    private boolean onIconLongClicked(View v) {
        ...
        final PopupContainerWithArrow container =
                (PopupContainerWithArrow) mActivity.getLayoutInflater().inflate(
                        com.android.launcher3.res.R.layout.popup_container, mActivity.getDragLayer(), false);
