...
public class PinnedAppsAdapter extends BaseAdapter implements OnSharedPreferenceChangeListener {
    ...
    private class PinUnPinShortcut extends SystemShortcut<SecondaryDisplayLauncher> {
        ...
        PinUnPinShortcut(SecondaryDisplayLauncher target, ItemInfo info, View originalView,
                boolean isPinned) {
            super(isPinned ? com.android.launcher3.res.R.drawable.ic_remove_no_shadow : com.android.launcher3.res.R.drawable.ic_pin,
                    isPinned ? com.android.launcher3.res.R.string.remove_drop_target_label : com.android.launcher3.res.R.string.action_add_to_workspace,
