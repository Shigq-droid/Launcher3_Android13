...
public class WorkspaceStateTransitionAnimation {
    ...
    public static <T extends View> ValueAnimator getSpringScaleAnimator(Launcher launcher, T v,
        ...
        float damping = rp.getFloat(com.android.launcher3.res.R.dimen.hint_scale_damping_ratio);
        float stiffness = rp.getFloat(com.android.launcher3.res.R.dimen.hint_scale_stiffness);
        float velocityPxPerS = rp.getDimension(com.android.launcher3.res.R.dimen.hint_scale_velocity_dp_per_s);
