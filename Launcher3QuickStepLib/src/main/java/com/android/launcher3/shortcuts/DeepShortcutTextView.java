...
public class DeepShortcutTextView extends BubbleTextView {
    ...
    public DeepShortcutTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragHandleWidth = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.popup_padding_end)
                + resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.deep_shortcut_drag_handle_size)
                + resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.deep_shortcut_drawable_padding) / 2;
    ...
    private void showLoadingState(boolean loading) {
        ...
        if (loading) {
            mLoadingStatePlaceholder = getContext().getDrawable(
                    com.android.launcher3.res.R.drawable.deep_shortcuts_text_placeholder);
            setLoadingBounds();
        } else {
    ...
    private void showToast() {
        ...
        CharSequence msg = Utilities.wrapForTts(
                getContext().getText(com.android.launcher3.res.R.string.long_press_shortcut_to_add),
                getContext().getString(com.android.launcher3.res.R.string.long_accessible_way_to_add_shortcut));
