...
public class Hotseat extends CellLayout implements Insettable {
    ...
    public Hotseat(Context context, AttributeSet attrs, int defStyle) {
        ...
        mQsb = LayoutInflater.from(context).inflate(com.android.launcher3.res.R.layout.search_container_hotseat, this, false);
        addView(mQsb);

        mQsbHeight = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.qsb_widget_height);
    }
