...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    public void bindAndInitFirstWorkspaceScreen() {
        ...
        if (mQsb == null) {
            ...
            mQsb = LayoutInflater.from(getContext())
                    .inflate(com.android.launcher3.res.R.layout.search_container_workspace, firstPage, false);
        }
        ...
        lp.canReorder = false;
        if (!firstPage.addViewToCellLayout(mQsb, 0, com.android.launcher3.res.R.id.search_container_workspace, lp, true)) {
    ...
    public CellLayout insertNewWorkspaceScreen(int screenId, int insertIndex) {
        ...
        CellLayout newScreen = (CellLayout) LayoutInflater.from(getContext()).inflate(
                com.android.launcher3.res.R.layout.workspace_screen, this, false /* attachToRoot */);
    ...
    public void onDrop(final DragObject d, DragOptions options) {
        ...
        if (d.stateAnnouncer != null && !droppedOnOriginalCell) {
            d.stateAnnouncer.completeAction(com.android.launcher3.res.R.string.item_moved);
        }
    }
    ...
    public void onNoCellFound(
        ...
        int strId = mLauncher.isHotseatLayout(dropTargetLayout)
                ? com.android.launcher3.res.R.string.hotseat_out_of_space : com.android.launcher3.res.R.string.out_of_space;
    ...
    private void enforceDragParity(View v, String event, int update, int expectedValue) {
        Object tag = v.getTag(com.android.launcher3.res.R.id.drag_event_parity);
        int value = tag == null ? 0 : (Integer) tag;
        value += update;
        v.setTag(com.android.launcher3.res.R.id.drag_event_parity, value);
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            switch (info.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                    view = FolderIcon.inflateFolderAndIcon(com.android.launcher3.res.R.layout.folder_icon, mLauncher, cellLayout,
                            (FolderInfo) info);
                    break;
                default:
    ...
    public void animateWidgetDrop(ItemInfo info, CellLayout cellLayout, final DragView dragView,
        ...
        final int duration = res.getInteger(com.android.launcher3.res.R.integer.config_dropAnimMaxDuration) - 200;
    ...
    private String getPageDescription(int page) {
        ...
        if (extraScreenId >= 0 && nScreens > 1) {
            if (page == extraScreenId) {
                return getContext().getString(com.android.launcher3.res.R.string.workspace_new_page);
            }
            nScreens--;
        }
        if (nScreens == 0) {
            // When the workspace is not loaded, we do not know how many screen will be bound.
            return getContext().getString(com.android.launcher3.res.R.string.home_screen);
        }
        int panelCount = getPanelCount();
        int currentPage = (page / panelCount) + 1;
        int totalPages = nScreens / panelCount + nScreens % panelCount;
        return getContext().getString(com.android.launcher3.res.R.string.workspace_scroll_format, currentPage, totalPages);
    }
