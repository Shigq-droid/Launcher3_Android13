...
public class TaskbarActivityContext extends BaseTaskbarContext {
    ...
    private void updateIconSize(Resources resources) {
        float taskbarIconSize = resources.getDimension(com.android.launcher3.res.R.dimen.taskbar_icon_size);
            ...
            if (info.isDisabled()) {
                ...
                try {
                    if (mIsSafeModeEnabled && !PackageManagerHelper.isSystemApp(this, intent)) {
                        Toast.makeText(this, com.android.launcher3.res.R.string.safemode_shortcut_error,
                    ...
                    Toast.makeText(this, com.android.launcher3.res.R.string.activity_not_found, Toast.LENGTH_SHORT)
                            .show();
