...
public final class Utilities {
    ...
    public static final boolean ATLEAST_R = Build.VERSION.SDK_INT >= VERSION_CODES.R;

    @ChecksSdkIntAtLeast(api = VERSION_CODES.S)
    public static final boolean ATLEAST_S = Build.VERSION.SDK_INT >= VERSION_CODES.S;

    @ChecksSdkIntAtLeast(api = VERSION_CODES.TIRAMISU, codename = "T")
    public static final boolean ATLEAST_T = Build.VERSION.SDK_INT >= VERSION_CODES.TIRAMISU;
    ...
    public static Drawable getBadge(Context context, ItemInfo info, Object obj) {
        ...
        if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT) {
            ...
            return Process.myUserHandle().equals(info.user)
                    ...
                    : context.getDrawable(com.android.launcher3.iconloader.R.drawable.ic_work_app_badge);
        }
    }
    ...
    public static List<SplitPositionOption> getSplitPositionOptions(
        ...
        if (dp.isTablet && dp.isLandscape) {
            options.add(new SplitPositionOption(
                    com.android.launcher3.res.R.drawable.ic_split_left, com.android.launcher3.res.R.string.split_screen_position_left,
                    STAGE_POSITION_TOP_OR_LEFT, STAGE_TYPE_MAIN));
            options.add(new SplitPositionOption(
                    com.android.launcher3.res.R.drawable.ic_split_right, com.android.launcher3.res.R.string.split_screen_position_right,
            ...
            if (dp.isSeascape()) {
                ...
                // Only add top option
                options.add(new SplitPositionOption(
                        com.android.launcher3.res.R.drawable.ic_split_top, com.android.launcher3.res.R.string.split_screen_position_top,
                        STAGE_POSITION_TOP_OR_LEFT, STAGE_TYPE_MAIN));
            }
        }
        return options;
