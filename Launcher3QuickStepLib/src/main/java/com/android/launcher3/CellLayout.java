...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.launcher3.res.R.styleable.CellLayout, defStyle, 0);
        mContainerType = a.getInteger(com.android.launcher3.res.R.styleable.CellLayout_containerType, WORKSPACE);
        a.recycle();
        ...
        mBackground = getContext().getDrawable(com.android.launcher3.res.R.drawable.bg_celllayout);
        mBackground.setCallback(this);
        mBackground.setAlpha(0);

        mGridColor = Themes.getAttrColor(getContext(), com.android.launcher3.res.R.attr.workspaceAccentColor);
        mGridVisualizationRoundingRadius =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.grid_visualization_rounding_radius);
        ...
        mDragOutlinePaint.setColor(Themes.getAttrColor(context, com.android.launcher3.res.R.attr.workspaceTextColor));

        // When dragging things around the home screens, we show a green outline of
        // where the item will land. The outlines gradually fade out, leaving a trail
        // behind the drag path.
        // Set up all the animations that are used to implement this fading.
        final int duration = res.getInteger(com.android.launcher3.res.R.integer.config_dragOutlineFadeTime);
        final float fromAlphaValue = 0;
        final float toAlphaValue = (float)res.getInteger(com.android.launcher3.res.R.integer.config_dragOutlineMaxAlpha);
    ...
    protected void dispatchSaveInstanceState(SparseArray<Parcelable> container) {
        ...
        container.put(com.android.launcher3.res.R.id.cell_layout_jail_id, jail);
    }
    ...
    private ParcelableSparseArray getJailedArray(SparseArray<Parcelable> container) {
        final Parcelable parcelable = container.get(com.android.launcher3.res.R.id.cell_layout_jail_id);
    ...
    public String getItemMoveDescription(int cellX, int cellY) {
        if (mContainerType == HOTSEAT) {
            return getContext().getString(com.android.launcher3.res.R.string.move_to_hotseat_position,
            ...
            return getContext().getString(com.android.launcher3.res.R.string.move_to_empty_cell, row, col);
        }
    }
