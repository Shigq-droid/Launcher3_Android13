        ...
        if (mLauncher.isInState(ALL_APPS)) {
            ...
            if (scrimEnabled) {
                ...
                int scrimColor = useTaskbarColor
                        ? mLauncher.getResources().getColor(com.android.launcher3.res.R.color.taskbar_background)
                        : Themes.getAttrColor(mLauncher, com.android.launcher3.res.R.attr.overviewScrimColor);
        ...
        if (anim == null) {
            ...
            if (fromUnlock) {
                ...
                float velocityPxPerS = DynamicResource.provider(mLauncher)
                        .getDimension(com.android.launcher3.res.R.dimen.unlock_staggered_velocity_dp_per_s);
