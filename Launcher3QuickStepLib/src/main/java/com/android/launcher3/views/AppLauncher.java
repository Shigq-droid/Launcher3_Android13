...
public interface AppLauncher extends ActivityContext {
    ...
    default boolean startActivitySafely(
        ...
        if (isAppBlockedForSafeMode() && !PackageManagerHelper.isSystemApp(context, intent)) {
            Toast.makeText(context, com.android.launcher3.res.R.string.safemode_shortcut_error, Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        try {
            ...
            Toast.makeText(context, com.android.launcher3.res.R.string.activity_not_found, Toast.LENGTH_SHORT).show();
