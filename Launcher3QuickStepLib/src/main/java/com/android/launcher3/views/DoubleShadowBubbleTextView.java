    ...
    public static class ShadowInfo {
        ...
        public ShadowInfo(Context c, AttributeSet attrs, int defStyle) {
            ...
            TypedArray a = c.obtainStyledAttributes(
                    attrs, com.android.launcher3.res.R.styleable.ShadowInfo, defStyle, 0);

            ambientShadowBlur = a.getDimensionPixelSize(
                    com.android.launcher3.res.R.styleable.ShadowInfo_ambientShadowBlur, 0);
            ambientShadowColor = a.getColor(com.android.launcher3.res.R.styleable.ShadowInfo_ambientShadowColor, 0);

            keyShadowBlur = a.getDimensionPixelSize(com.android.launcher3.res.R.styleable.ShadowInfo_keyShadowBlur, 0);
            keyShadowOffsetX = a.getDimensionPixelSize(com.android.launcher3.res.R.styleable.ShadowInfo_keyShadowOffsetX, 0);
            keyShadowOffsetY = a.getDimensionPixelSize(com.android.launcher3.res.R.styleable.ShadowInfo_keyShadowOffsetY, 0);
            keyShadowColor = a.getColor(com.android.launcher3.res.R.styleable.ShadowInfo_keyShadowColor, 0);
            a.recycle();
        }
