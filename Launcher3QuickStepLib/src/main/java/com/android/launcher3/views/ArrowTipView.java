...
public class ArrowTipView extends AbstractFloatingView {
    ...
    public ArrowTipView(Context context, boolean isPointingUp) {
        ...
        mArrowWidth = context.getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.arrow_toast_arrow_width);
    ...
    private void init(Context context) {
        inflate(context, com.android.launcher3.res.R.layout.arrow_toast, this);
        setOrientation(LinearLayout.VERTICAL);

        mArrowView = findViewById(com.android.launcher3.res.R.id.arrow);
    ...
    @Nullable private ArrowTipView showAtLocation(String text, @Px int arrowXCoord,
        ...
        @Px int maxTextViewWidth = getContext().getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_picker_education_tip_max_width);
        @Px int minViewMargin = getContext().getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.widget_picker_education_tip_min_margin);
    ...
    private void updateArrowTipInView() {
        ...
        @Px int arrowTipRadius = getContext().getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.arrow_toast_corner_radius);
        arrowPaint.setColor(ContextCompat.getColor(getContext(), com.android.launcher3.res.R.color.arrow_tip_view_bg));
