...
public class RecyclerViewFastScroller extends View {
    ...
    public RecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWidth = mMinWidth = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.fastscroll_track_min_width);
        mMaxWidth = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.fastscroll_track_max_width);

        mThumbPadding = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.fastscroll_thumb_padding);
        mThumbHeight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.fastscroll_thumb_height);
        ...
        TypedArray ta =
                context.obtainStyledAttributes(attrs, com.android.launcher3.res.R.styleable.RecyclerViewFastScroller, defStyleAttr, 0);
        mCanThumbDetach = ta.getBoolean(com.android.launcher3.res.R.styleable.RecyclerViewFastScroller_canThumbDetach, false);
        ta.recycle();
    }
