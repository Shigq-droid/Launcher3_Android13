...
public class AllAppsButton extends BubbleTextView {
    ...
    public AllAppsButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        Context theme = new ContextThemeWrapper(context, com.android.launcher3.res.R.style.AllAppsButtonTheme);
        Bitmap bitmap = LauncherAppState.getInstance(context).getIconCache().getIconFactory()
                .createScaledBitmapWithShadow(theme.getDrawable(com.android.launcher3.res.R.drawable.ic_all_apps_button));
