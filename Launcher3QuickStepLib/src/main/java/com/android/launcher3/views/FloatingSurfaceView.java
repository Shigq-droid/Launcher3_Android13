...
public class FloatingSurfaceView extends AbstractFloatingView implements
    ...
    protected void handleClose(boolean animate) {
        ...
        mLauncher.getViewCache().recycleView(com.android.launcher3.res.R.layout.floating_surface_view, this);
        mContract = null;
        mIcon = null;
        mIsOpen = false;
    ...
    public static void show(Launcher launcher, GestureNavContract contract) {
        FloatingSurfaceView view = launcher.getViewCache().getView(com.android.launcher3.res.R.layout.floating_surface_view,
