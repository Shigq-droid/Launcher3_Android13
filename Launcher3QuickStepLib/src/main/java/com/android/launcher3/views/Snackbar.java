...
public class Snackbar extends AbstractFloatingView {
    ...
    public Snackbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, com.android.launcher3.res.R.layout.snackbar, this);
    }
    ...
    public static <T extends Context & ActivityContext> void show(T activity, int labelStringResId,
        ...
        snackbar.setElevation(res.getDimension(com.android.launcher3.res.R.dimen.snackbar_elevation));
        int padding = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_padding);
        snackbar.setPadding(padding, padding, padding, padding);
        snackbar.setBackgroundResource(com.android.launcher3.res.R.drawable.round_rect_primary);
        ...
        params.height = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_height);
        int maxMarginLeftRight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_max_margin_left_right);
        int minMarginLeftRight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_min_margin_left_right);
        int marginBottom = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_margin_bottom);
        int absoluteMaxWidth = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_max_width);
        ...
        TextView labelView = snackbar.findViewById(com.android.launcher3.res.R.id.label);
        String labelText = res.getString(labelStringResId);
        labelView.setText(labelText);

        TextView actionView = snackbar.findViewById(com.android.launcher3.res.R.id.action);
        float actionWidth;
        ...
        if (totalContentWidth > params.width) {
            ...
            if (totalContentWidth <= maxWidth) {
                ...
                int textHeight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.snackbar_content_height);
                float textSizePx = res.getDimension(com.android.launcher3.res.R.dimen.snackbar_min_text_size);
