...
public class FloatingIconView extends FrameLayout implements
    ...
    private static int getOffsetForIconBounds(Launcher l, Drawable drawable, RectF position) {
        ...
        int blurSizeOutline =
                l.getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.blur_size_medium_outline);
    ...
    public static FloatingIconView getFloatingIconView(Launcher launcher, View originalView,
        ...
        FloatingIconView view = launcher.getViewCache().getView(com.android.launcher3.res.R.layout.floating_icon_view,
                launcher, parent);
        view.recycle();
    ...
    private void finish(DragLayer dragLayer) {
        ...
        recycle();
        mLauncher.getViewCache().recycleView(com.android.launcher3.res.R.layout.floating_icon_view, this);
    }
