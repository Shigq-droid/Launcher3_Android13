...
public class AccessibilityActionsView extends View implements StateListener<LauncherState> {
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo() {
        ...
        info.addAction(new AccessibilityAction(
                com.android.launcher3.res.R.string.all_apps_button_label, l.getText(com.android.launcher3.res.R.string.all_apps_button_label)));
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        Launcher l = Launcher.getLauncher(getContext());
        if (action == com.android.launcher3.res.R.string.all_apps_button_label) {
