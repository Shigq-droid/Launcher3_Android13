...
public class OptionsPopupView extends ArrowPopup<Launcher>
    ...
    public static OptionsPopupView show(
        ...
        OptionsPopupView popup = (OptionsPopupView) launcher.getLayoutInflater()
                .inflate(com.android.launcher3.res.R.layout.longpress_options_menu, launcher.getDragLayer(), false);
        popup.mTargetRect = targetRect;
        popup.setShouldAddArrow(shouldAddArrow);

        for (OptionItem item : items) {
            DeepShortcutView view =
                    (DeepShortcutView) popup.inflateAndAdd(com.android.launcher3.res.R.layout.system_shortcut, popup);
            if (width > 0) {
    ...
    // remove the wallpaper style entry for launcher
    /**
...
//                com.android.launcher3.res.R.string.styles_wallpaper_button_text : com.android.launcher3.res.R.string.wallpaper_button_text;
...
//                OptionsPopupView::startWallpaperPicker));
        if (!WidgetsModel.GO_DISABLE_WIDGETS) {
            options.add(new OptionItem(launcher,
                    com.android.launcher3.res.R.string.widget_button_text,
                    com.android.launcher3.res.R.drawable.ic_widget,
                    LAUNCHER_WIDGETSTRAY_BUTTON_TAP_OR_LONGPRESS,
                    OptionsPopupView::onWidgetsClicked));
        }
        options.add(new OptionItem(launcher,
                com.android.launcher3.res.R.string.settings_button_text,
                com.android.launcher3.res.R.drawable.ic_setting,
    ...
    private static boolean startWallpaperPicker(View v) {
        ...
        if (!Utilities.isWallpaperAllowed(launcher)) {
            String message = launcher.getStringCache() != null
                    ...
                    : launcher.getString(com.android.launcher3.res.R.string.msg_disabled_by_admin);
        ...
        String pickerPackage = launcher.getString(com.android.launcher3.res.R.string.wallpaper_picker_package);
