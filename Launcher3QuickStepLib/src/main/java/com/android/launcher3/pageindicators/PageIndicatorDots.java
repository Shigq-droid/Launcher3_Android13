...
public class PageIndicatorDots extends View implements PageIndicator {
    ...
    public PageIndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCirclePaint.setColor(Themes.getAttrColor(context, com.android.launcher3.res.R.attr.folderPaginationColor));
        mDotRadius = getResources().getDimension(com.android.launcher3.res.R.dimen.page_indicator_dot_size) / 2;
