...
public class WorkspacePageIndicator extends View implements Insettable, PageIndicator {
    ...
    public WorkspacePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLineHeight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.workspace_page_indicator_line_height);

        boolean darkText = Themes.getAttrBoolean(mLauncher, com.android.launcher3.res.R.attr.isWorkspaceDarkText);
