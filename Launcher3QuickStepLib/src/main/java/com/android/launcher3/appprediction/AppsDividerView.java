...
public class AppsDividerView extends View implements FloatingHeaderRow {
    ...
    public AppsDividerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean isMainColorDark = Themes.getAttrBoolean(context, com.android.launcher3.res.R.attr.isMainColorDark);
        mDividerSize = new int[]{
                getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_divider_width),
                getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_divider_height)
        };
    ...
    private Layout getAllAppsLabelLayout() {
        if (mAllAppsLabelLayout == null) {
            ...
            CharSequence allAppsLabelText = getResources().getText(com.android.launcher3.res.R.string.all_apps_label);
