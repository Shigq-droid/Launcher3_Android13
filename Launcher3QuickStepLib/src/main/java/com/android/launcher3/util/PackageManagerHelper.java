...
public class PackageManagerHelper {
    ...
    public static Intent getMarketSearchIntent(Context context, String query) {
        try {
            Intent intent = Intent.parseUri(context.getString(com.android.launcher3.res.R.string.market_search_intent), 0);
    ...
    public static Intent getStyleWallpapersIntent(Context context) {
        return new Intent(Intent.ACTION_SET_WALLPAPER).setComponent(
                new ComponentName(context.getString(com.android.launcher3.res.R.string.wallpaper_picker_package),
                    context.getString(com.android.launcher3.res.R.string.custom_activity_picker)
                ));
    }
    ...
    public void startDetailsActivityForInfo(ItemInfo info, Rect sourceBounds, Bundle opts) {
        ...
        if (componentName != null) {
            try {
                ...
                Toast.makeText(mContext, com.android.launcher3.res.R.string.activity_not_found, Toast.LENGTH_SHORT).show();
