...
public class Themes {
    ...
    public static int getActivityThemeRes(Context context, int wallpaperColorHints) {
        ...
        if (Utilities.isDarkTheme(context)) {
            return supportsDarkText ? com.android.launcher3.res.R.style.AppTheme_Dark_DarkText
                    : isMainColorDark ? com.android.launcher3.res.R.style.AppTheme_Dark_DarkMainColor : com.android.launcher3.res.R.style.AppTheme_Dark;
        } else {
            return supportsDarkText ? com.android.launcher3.res.R.style.AppTheme_DarkText
                    : isMainColorDark ? com.android.launcher3.res.R.style.AppTheme_DarkMainColor : com.android.launcher3.res.R.style.AppTheme;
        }
    }
    ...
    public static float getDialogCornerRadius(Context context) {
        return getDimension(context, android.R.attr.dialogCornerRadius,
                context.getResources().getDimension(com.android.launcher3.res.R.dimen.default_dialog_corner_radius));
    }
