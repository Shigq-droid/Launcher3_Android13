...
public abstract class DragView<T extends Context & ActivityContext> extends FrameLayout {
    ...
    public DragView(T activity, View content, int width, int height, int registrationX,
        ...
        mBlurSizeOutline = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.blur_size_medium_outline);
        setElevation(getResources().getDimension(com.android.launcher3.res.R.dimen.drag_elevation));
        ...
        MODEL_EXECUTOR.getHandler().postAtFrontOfQueue(() -> {
            ...
            if (dr instanceof AdaptiveIconDrawable) {
                int blurMargin = (int) mActivity.getResources()
                        .getDimension(com.android.launcher3.res.R.dimen.blur_size_medium_outline) / 2;
