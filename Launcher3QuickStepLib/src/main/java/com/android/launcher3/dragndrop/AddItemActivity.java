...
public class AddItemActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.android.launcher3.res.R.layout.add_item_confirmation_activity);
        // Set flag to allow activity to draw over navigation and status bar.
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS,
                WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
        mDragLayer = findViewById(com.android.launcher3.res.R.id.add_item_drag_layer);
        mDragLayer.recreateControllers();
        mWidgetCell = findViewById(com.android.launcher3.res.R.id.widget_cell);
        ...
        WidgetCellPreview previewContainer = mWidgetCell.findViewById(
                com.android.launcher3.res.R.id.widget_preview_container);
        ...
        TextView widgetAppName = findViewById(com.android.launcher3.res.R.id.widget_appName);
        widgetAppName.setText(getApplicationInfo().labelRes);

        mSlideInView = findViewById(com.android.launcher3.res.R.id.add_item_bottom_sheet);
        ...
        if (mAccessibilityManager.isEnabled()) {
            ...
            event.setContentDescription(
                    getApplicationContext().getResources().getString(
                            com.android.launcher3.res. R.string.added_to_home_screen_accessibility_text, widgetName));
