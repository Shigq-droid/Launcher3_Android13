...
public class StringCache {
    ...
    public void loadStrings(Context context) {
        workProfileEdu = getEnterpriseString(
                context, WORK_PROFILE_EDU, com.android.launcher3.res.R.string.work_profile_edu_work_apps);
        workProfileEduAccept = getEnterpriseString(
                context, WORK_PROFILE_EDU_ACCEPT, com.android.launcher3.res.R.string.work_profile_edu_accept);
        workProfilePausedTitle = getEnterpriseString(
                context, WORK_PROFILE_PAUSED_TITLE, com.android.launcher3.res.R.string.work_apps_paused_title);
        workProfilePausedDescription = getEnterpriseString(
                context, WORK_PROFILE_PAUSED_DESCRIPTION, com.android.launcher3.res.R.string.work_apps_paused_body);
        workProfilePauseButton = getEnterpriseString(
                context, WORK_PROFILE_PAUSE_BUTTON, com.android.launcher3.res.R.string.work_apps_pause_btn_text);
        workProfileEnableButton = getEnterpriseString(
                context, WORK_PROFILE_ENABLE_BUTTON, com.android.launcher3.res.R.string.work_apps_enable_btn_text);
        allAppsWorkTab = getEnterpriseString(
                context, ALL_APPS_WORK_TAB, com.android.launcher3.res.R.string.all_apps_work_tab);
        allAppsPersonalTab = getEnterpriseString(
                context, ALL_APPS_PERSONAL_TAB, com.android.launcher3.res.R.string.all_apps_personal_tab);
        allAppsWorkTabAccessibility = getEnterpriseString(
                context, ALL_APPS_WORK_TAB_ACCESSIBILITY, com.android.launcher3.res.R.string.all_apps_button_work_label);
        allAppsPersonalTabAccessibility = getEnterpriseString(
                context, ALL_APPS_PERSONAL_TAB_ACCESSIBILITY,
                com.android.launcher3.res.R.string.all_apps_button_personal_label);
        workFolderName = getEnterpriseString(
                context, WORK_FOLDER_NAME, com.android.launcher3.res.R.string.work_folder_name);
        widgetsWorkTab = getEnterpriseString(
                context, WIDGETS_WORK_TAB, com.android.launcher3.res.R.string.widgets_full_sheet_work_tab);
        widgetsPersonalTab = getEnterpriseString(
                context, WIDGETS_PERSONAL_TAB, com.android.launcher3.res.R.string.widgets_full_sheet_personal_tab);
        disabledByAdminMessage = getEnterpriseString(
                context, DISABLED_BY_ADMIN_MESSAGE, com.android.launcher3.res.R.string.msg_disabled_by_admin);
    }
