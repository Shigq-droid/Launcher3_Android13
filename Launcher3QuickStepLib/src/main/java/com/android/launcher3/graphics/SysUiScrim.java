...
public class SysUiScrim implements View.OnAttachStateChangeListener {
    ...
    public SysUiScrim(View view) {
        ...
        mTopScrim = Themes.getAttrDrawable(view.getContext(), com.android.launcher3.res.R.attr.workspaceStatusBarScrim);
        mBottomMask = mTopScrim == null ? null : createDitheredAlphaMask();
        mHideSysUiScrim = mTopScrim == null;

        mDrawWallpaperScrim = FeatureFlags.ENABLE_WALLPAPER_SCRIM.get()
                && !Themes.getAttrBoolean(view.getContext(), com.android.launcher3.res.R.attr.isMainColorDark)
                && !Themes.getAttrBoolean(view.getContext(), com.android.launcher3.res.R.attr.isWorkspaceDarkText);
        ResourceProvider rp = DynamicResource.provider(view.getContext());
        int wallpaperScrimColor = rp.getColor(com.android.launcher3.res.R.color.wallpaper_scrim_color);
