...
public abstract class IconShape {
    ...
    private static List<IconShape> getAllShapes(Context context) {
        ...
        try (XmlResourceParser parser = context.getResources().getXml(com.android.launcher3.res.R.xml.folder_shapes)) {
            ...
            int[] radiusAttr = new int[] {com.android.launcher3.res.R.attr.folderIconRadius};
