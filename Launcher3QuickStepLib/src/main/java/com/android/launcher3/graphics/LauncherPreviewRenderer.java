...
public class LauncherPreviewRenderer extends ContextWrapper
    ...
    public LauncherPreviewRenderer(Context context,
        ...
        mWorkspaceItemInfo.contentDescription = mWorkspaceItemInfo.title =
                context.getString(com.android.launcher3.res.R.string.label_application);

        mHomeElementInflater = LayoutInflater.from(
                new ContextThemeWrapper(this, com.android.launcher3.res.R.style.HomeScreenElementTheme));
        mHomeElementInflater.setFactory2(this);

        int layoutRes = mDp.isTwoPanels ? com.android.launcher3.res.R.layout.launcher_preview_two_panel_layout
                : com.android.launcher3.res.R.layout.launcher_preview_layout;
        mRootView = (InsettableFrameLayout) mHomeElementInflater.inflate(
                layoutRes, null, false);
        mRootView.setInsets(mInsets);
        measureView(mRootView, mDp.widthPx, mDp.heightPx);

        mHotseat = mRootView.findViewById(com.android.launcher3.res.R.id.hotseat);
        mHotseat.resetLayout(false);

        CellLayout firstScreen = mRootView.findViewById(com.android.launcher3.res.R.id.workspace);
        ...
        if (mDp.isTwoPanels) {
            CellLayout rightPanel = mRootView.findViewById(com.android.launcher3.res.R.id.workspace_right);
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.android.launcher3.res.R.styleable.PreviewFragment);
        FragmentWithPreview f = (FragmentWithPreview) Fragment.instantiate(
                context, ta.getString(com.android.launcher3.res.R.styleable.PreviewFragment_android_name));
        f.enterPreviewMode(context);
        f.onInit(null);

        View view = f.onCreateView(LayoutInflater.from(context), (ViewGroup) parent, null);
        view.setId(ta.getInt(com.android.launcher3.res.R.styleable.PreviewFragment_android_id, View.NO_ID));
        return view;
    }
    ...
    private void inflateAndAddIcon(WorkspaceItemInfo info) {
        ...
        BubbleTextView icon = (BubbleTextView) mHomeElementInflater.inflate(
                com.android.launcher3.res.R.layout.app_icon, screen, false);
    ...
    private void inflateAndAddFolder(FolderInfo info) {
        CellLayout screen = info.container == Favorites.CONTAINER_DESKTOP
                ...
                : mHotseat;
        FolderIcon folderIcon = FolderIcon.inflateIcon(com.android.launcher3.res.R.layout.folder_icon, this, screen,
                info);
    ...
    private void populate(BgDataModel dataModel,
        ...
        if (FeatureFlags.QSB_ON_FIRST_SCREEN) {
            ...
            View qsb = mHomeElementInflater.inflate(com.android.launcher3.res.R.layout.qsb_preview, firstScreen,
                    false);
            CellLayout.LayoutParams lp =
                    new CellLayout.LayoutParams(0, 0, firstScreen.getCountX(), 1);
            lp.canReorder = false;
            firstScreen.addViewToCellLayout(qsb, 0, com.android.launcher3.res.R.id.search_container_workspace, lp, true);
        }
