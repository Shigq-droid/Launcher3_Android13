...
public class DragPreviewProvider {
    ...
    public DragPreviewProvider(View view, Context context) {
        mView = view;
        blurSizeOutline =
                context.getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.blur_size_medium_outline);
    ...
    private class OutlineGeneratorCallback implements Runnable {
        ...
        public void run() {
            ...
            paint.setMaskFilter(new BlurMaskFilter(
                    mContext.getResources().getDimension(com.android.launcher3.res.R.dimen.blur_size_thin_outline),
