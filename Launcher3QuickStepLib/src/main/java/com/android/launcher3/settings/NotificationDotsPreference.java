...
public class NotificationDotsPreference extends Preference
    ...
    public void onSettingsChanged(boolean enabled) {
        int summary = enabled
                ? com.android.launcher3.res.R.string.notification_dots_desc_on
                : com.android.launcher3.res.R.string.notification_dots_desc_off;
        ...
        if (enabled) {
            ...
            if (!serviceEnabled) {
                summary = com.android.launcher3.res.R.string.title_missing_notification_access;
            }
        }
    ...
    public static class NotificationAccessConfirmation
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            String msg = context.getString(com.android.launcher3.res.R.string.msg_missing_notification_access,
                    context.getString(R.string.derived_app_name));
            return new AlertDialog.Builder(context)
                    .setTitle(com.android.launcher3.res.R.string.title_missing_notification_access)
                    .setMessage(msg)
                    .setNegativeButton(android.R.string.cancel, null)
                    .setPositiveButton(com.android.launcher3.res.R.string.title_change_settings, this)
                    .create();
        }
