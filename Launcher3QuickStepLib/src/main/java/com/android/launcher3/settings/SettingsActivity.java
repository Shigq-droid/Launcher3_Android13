...
public class SettingsActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.android.launcher3.res.R.layout.settings_activity);
        setActionBar(findViewById(com.android.launcher3.res.R.id.action_bar));
        ...
        if (savedInstanceState == null) {
            ...
            fm.beginTransaction().replace(com.android.launcher3.res.R.id.content_frame, f).commit();
        }
    ...
    private String getPreferenceFragment() {
        ...
        String defaultFragment = getString(com.android.launcher3.res.R.string.settings_fragment_name);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
        ...
        return startPreference(getString(com.android.launcher3.res.R.string.settings_fragment_name), args, pref.getKey());
    }
    ...
    public static class LauncherSettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            setPreferencesFromResource(com.android.launcher3.res.R.xml.launcher_preferences, rootKey);
            ...
            if (getActivity() != null && !TextUtils.isEmpty(getPreferenceScreen().getTitle())) {
                if (getPreferenceScreen().getTitle().equals(
                        getResources().getString(com.android.launcher3.res.R.string.search_pref_screen_title))){
                    ...
                    getPreferenceScreen().setTitle(mDeviceProfile.isTablet ?
                            com.android.launcher3.res. R.string.search_pref_screen_title_tablet
                            :com.android.launcher3.res. R.string.search_pref_screen_title);
                }
