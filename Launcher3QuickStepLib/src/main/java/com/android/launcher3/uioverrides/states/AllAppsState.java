...
public class AllAppsState extends LauncherState {
    ...
    public int getWorkspaceScrimColor(Launcher launcher) {
        return launcher.getDeviceProfile().isTablet
                ? launcher.getResources().getColor(com.android.launcher3.res.R.color.widgets_picker_scrim)
                : Themes.getAttrColor(launcher, com.android.launcher3.res.R.attr.allAppsScrimColor);
    }
}
