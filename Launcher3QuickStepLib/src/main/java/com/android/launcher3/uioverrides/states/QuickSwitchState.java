...
public class QuickSwitchState extends BackgroundAppState {
    ...
    public int getWorkspaceScrimColor(Launcher launcher) {
        ...
        if (dp.isTaskbarPresentInApps) {
            return launcher.getColor(com.android.launcher3.res.R.color.taskbar_background);
        }
        return Themes.getAttrColor(launcher, com.android.launcher3.res.R.attr.overviewScrimColor);
    }
