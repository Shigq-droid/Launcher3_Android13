...
public abstract class PagedView<T extends View & PageIndicator> extends ViewGroup {
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.android.launcher3.res.R.styleable.PagedView, defStyle, 0);
        mPageIndicatorViewId = a.getResourceId(com.android.launcher3.res.R.styleable.PagedView_pageIndicator, -1);
        a.recycle();
    ...
    private void updateVelocityValues() {
        ...
        mFlingThresholdVelocity = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.fling_threshold_velocity);
        mEasyFlingThresholdVelocity =
                res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.easy_fling_threshold_velocity);
        mMinFlingVelocity = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.min_fling_velocity);
        mMinSnapVelocity = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.min_page_snap_velocity);
        mPageSnapAnimationDuration = res.getInteger(com.android.launcher3.res.R.integer.config_pageSnapAnimationDuration);
    }
    ...
    protected String getCurrentPageDescription() {
        return getContext().getString(com.android.launcher3.res.R.string.default_scroll_format,
