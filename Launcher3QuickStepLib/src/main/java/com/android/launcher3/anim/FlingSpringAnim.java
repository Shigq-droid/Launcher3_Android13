...
public class FlingSpringAnim {
    ...
    public <K> FlingSpringAnim(K object, Context context, FloatPropertyCompat<K> property,
        ...
        float damping = rp.getFloat(com.android.launcher3.res.R.dimen.swipe_up_rect_xy_damping_ratio);
        float stiffness = rp.getFloat(com.android.launcher3.res.R.dimen.swipe_up_rect_xy_stiffness);
        float friction = rp.getFloat(com.android.launcher3.res.R.dimen.swipe_up_rect_xy_fling_friction);
