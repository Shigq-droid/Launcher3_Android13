...
public class ItemClickHandler {
    ...
    private static void onClickPendingWidget(PendingAppWidgetHostView v, Launcher launcher) {
        if (launcher.getPackageManager().isSafeMode()) {
            Toast.makeText(launcher, com.android.launcher3.res.R.string.safemode_widget_error, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private static void onClickPendingAppItem(View v, Launcher launcher, String packageName,
        ...
        new AlertDialog.Builder(launcher)
                .setTitle(com.android.launcher3.res.R.string.abandoned_promises_title)
                .setMessage(com.android.launcher3.res.R.string.abandoned_promise_explanation)
                .setPositiveButton(com.android.launcher3.res.R.string.abandoned_search,
                        (d, i) -> startMarketIntentForPackage(v, launcher, packageName))
                .setNeutralButton(com.android.launcher3.res.R.string.abandoned_clean_this,
    ...
    public static boolean handleDisabledItemClicked(WorkspaceItemInfo shortcut, Context context) {
        ...
        if ((disabledFlags
            ...
            int error = com.android.launcher3.res.R.string.activity_not_available;
            if ((shortcut.runtimeStatusFlags & FLAG_DISABLED_SAFEMODE) != 0) {
                error = com.android.launcher3.res.R.string.safemode_shortcut_error;
            } else if ((shortcut.runtimeStatusFlags & FLAG_DISABLED_BY_PUBLISHER) != 0
                    || (shortcut.runtimeStatusFlags & FLAG_DISABLED_LOCKED_USER) != 0) {
                error = com.android.launcher3.res.R.string.shortcut_not_available;
            }
        ...
        try {
            ...
            if (shortcut.itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT
                ...
                new AlertDialog.Builder(context)
                        .setTitle(com.android.launcher3.res.R.string.dialog_update_title)
                        .setMessage(com.android.launcher3.res.R.string.dialog_update_message)
                        .setPositiveButton(com.android.launcher3.res.R.string.dialog_update, (d, i) -> {
                            // Direct the user to the play store to update the app
                            context.startActivity(shortcut.getMarketIntent(context));
                        })
                        .setNeutralButton(com.android.launcher3.res.R.string.dialog_remove, (d, i) -> {
        ...
        if (itemInfo.getIntent() != null) {
            ...
            try {
                ...
                Toast.makeText(launcher,
                        launcher.getResources().getText(com.android.launcher3.res.R.string.shortcut_not_available),
