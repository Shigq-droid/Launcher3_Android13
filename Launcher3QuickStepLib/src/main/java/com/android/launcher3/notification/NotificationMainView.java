...
public class NotificationMainView extends LinearLayout {
    ...
    public NotificationMainView(Context context, AttributeSet attrs, int defStyle, int defStylRes) {
        ...
        mBackground.setColor(Themes.getAttrColor(context, com.android.launcher3.res.R.attr.popupColorPrimary));
        mBackground.setCornerRadius(outlineRadius);
        setBackground(mBackground);

        mMaxElevation = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.deep_shortcuts_elevation);
        setElevation(mMaxElevation);

        mMaxTransX = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.notification_max_trans);
        mNotificationSpace = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.notification_space);
    ...
    protected void onFinishInflate() {
        ...
        ViewGroup textAndBackground = findViewById(com.android.launcher3.res.R.id.text_and_background);
        mTitleView = textAndBackground.findViewById(R.id.title);
        mTextView = textAndBackground.findViewById(R.id.text);
        mIconView = findViewById(com.android.launcher3.res.R.id.popup_item_icon);
        mHeaderCount = findViewById(com.android.launcher3.res.R.id.notification_count);

        mHeader = findViewById(com.android.launcher3.res.R.id.header);
        mMainView = findViewById(com.android.launcher3.res.R.id.main_view);
    }
