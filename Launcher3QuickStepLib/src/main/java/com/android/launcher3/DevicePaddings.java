                    ...
                    while (((type = parser.next()) != XmlPullParser.END_TAG ||
                        ...
                        if ((type == XmlPullParser.START_TAG)
                            ...
                            TypedArray a = context.obtainStyledAttributes(
                                    Xml.asAttributeSet(parser), com.android.launcher3.res.R.styleable.DevicePadding);
                            int maxWidthPx = a.getDimensionPixelSize(
                                    com.android.launcher3.res.R.styleable.DevicePadding_maxEmptySpace, 0);
                            a.recycle();
    ...
    private static final class PaddingFormula {
        ...
        public PaddingFormula(Context context, AttributeSet attrs) {
            TypedArray t = context.obtainStyledAttributes(attrs,
                    com.android.launcher3.res.R.styleable.DevicePaddingFormula);

            a = getValue(t, com.android.launcher3.res.R.styleable.DevicePaddingFormula_a);
            b = getValue(t, com.android.launcher3.res.R.styleable.DevicePaddingFormula_b);
            c = getValue(t, com.android.launcher3.res.R.styleable.DevicePaddingFormula_c);
