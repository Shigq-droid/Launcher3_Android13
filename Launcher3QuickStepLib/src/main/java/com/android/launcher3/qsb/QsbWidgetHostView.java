...
public class QsbWidgetHostView extends NavigableAppWidgetHostView {
    ...
    public QsbWidgetHostView(Context context) {
        super(context);
        setFocusable(true);
        setBackgroundResource(com.android.launcher3.res.R.drawable.qsb_host_view_focus_bg);
    }
    ...
    public static View getDefaultView(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(com.android.launcher3.res.R.layout.qsb_default_view, parent, false);
        v.findViewById(com.android.launcher3.res.R.id.btn_qsb_search).setOnClickListener((v2) ->
