...
public class LauncherAccessibilityDelegate extends BaseAccessibilityDelegate<Launcher> {
    ...
    public static final int REMOVE = com.android.launcher3.res.R.id.action_remove;
    public static final int UNINSTALL = com.android.launcher3.res.R.id.action_uninstall;
    public static final int DISMISS_PREDICTION = com.android.launcher3.res.R.id.action_dismiss_prediction;
    public static final int PIN_PREDICTION = com.android.launcher3.res.R.id.action_pin_prediction;
    public static final int RECONFIGURE = com.android.launcher3.res.R.id.action_reconfigure;
    public static final int INVALID = -1;
    protected static final int ADD_TO_WORKSPACE = com.android.launcher3.res.R.id.action_add_to_workspace;
    protected static final int MOVE = com.android.launcher3.res.R.id.action_move;
    protected static final int MOVE_TO_WORKSPACE = com.android.launcher3.res.R.id.action_move_to_workspace;
    protected static final int RESIZE = com.android.launcher3.res.R.id.action_resize;
    public static final int DEEP_SHORTCUTS = com.android.launcher3.res.R.id.action_deep_shortcuts;
    public static final int SHORTCUTS_AND_NOTIFICATIONS = com.android.launcher3.res.R.id.action_shortcuts_and_notifications;

    public LauncherAccessibilityDelegate(Launcher launcher) {
        super(launcher);

        mActions.put(REMOVE, new LauncherAction(
                REMOVE, com.android.launcher3.res.R.string.remove_drop_target_label, KeyEvent.KEYCODE_X));
        mActions.put(UNINSTALL, new LauncherAction(
                UNINSTALL, com.android.launcher3.res.R.string.uninstall_drop_target_label, KeyEvent.KEYCODE_U));
        mActions.put(DISMISS_PREDICTION, new LauncherAction(DISMISS_PREDICTION,
                com.android.launcher3.res.R.string.dismiss_prediction_label, KeyEvent.KEYCODE_X));
        mActions.put(RECONFIGURE, new LauncherAction(
                RECONFIGURE, com.android.launcher3.res.R.string.gadget_setup_text, KeyEvent.KEYCODE_E));
        mActions.put(ADD_TO_WORKSPACE, new LauncherAction(
                ADD_TO_WORKSPACE, com.android.launcher3.res.R.string.action_add_to_workspace, KeyEvent.KEYCODE_P));
        mActions.put(MOVE, new LauncherAction(
                MOVE, com.android.launcher3.res.R.string.action_move, KeyEvent.KEYCODE_M));
        mActions.put(MOVE_TO_WORKSPACE, new LauncherAction(MOVE_TO_WORKSPACE,
                com.android.launcher3.res.R.string.action_move_to_workspace, KeyEvent.KEYCODE_P));
        mActions.put(RESIZE, new LauncherAction(
                RESIZE, com.android.launcher3.res.R.string.action_resize, KeyEvent.KEYCODE_R));
        mActions.put(DEEP_SHORTCUTS, new LauncherAction(DEEP_SHORTCUTS,
                com.android.launcher3.res.R.string.action_deep_shortcut, KeyEvent.KEYCODE_S));
        mActions.put(SHORTCUTS_AND_NOTIFICATIONS, new LauncherAction(DEEP_SHORTCUTS,
                com.android.launcher3.res.R.string.shortcuts_menu_with_notifications_description, KeyEvent.KEYCODE_S));
    }
    ...
    private List<OptionItem> getSupportedResizeActions(View host, LauncherAppWidgetInfo info) {
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_HORIZONTAL) != 0) {
            if (layout.isRegionVacant(info.cellX + info.spanX, info.cellY, 1, info.spanY) ||
                ...
                actions.add(new OptionItem(mContext,
                        com.android.launcher3.res.R.string.action_increase_width,
                        com.android.launcher3.res. R.drawable.ic_widget_width_increase,
                        IGNORE,
                        v -> performResizeAction(com.android.launcher3.res.R.string.action_increase_width, host, info)));
            }

            if (info.spanX > info.minSpanX && info.spanX > 1) {
                actions.add(new OptionItem(mContext,
                        com.android.launcher3.res.R.string.action_decrease_width,
                        com.android.launcher3.res.R.drawable.ic_widget_width_decrease,
                        IGNORE,
                        v -> performResizeAction(com.android.launcher3.res.R.string.action_decrease_width, host, info)));
            }
        }
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_VERTICAL) != 0) {
            if (layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1) ||
                ...
                actions.add(new OptionItem(mContext,
                        com.android.launcher3.res.R.string.action_increase_height,
                        com.android.launcher3.res.R.drawable.ic_widget_height_increase,
                        IGNORE,
                        v -> performResizeAction(com.android.launcher3.res.R.string.action_increase_height, host, info)));
            }

            if (info.spanY > info.minSpanY && info.spanY > 1) {
                actions.add(new OptionItem(mContext,
                        com.android.launcher3.res.R.string.action_decrease_height,
                        com.android.launcher3.res. R.drawable.ic_widget_height_decrease,
                        IGNORE,
                        v -> performResizeAction(com.android.launcher3.res.R.string.action_decrease_height, host, info)));
            }
        }
        return actions;
    }
    ...
    private boolean performResizeAction(int action, View host, LauncherAppWidgetInfo info) {
        ...
        if (action == com.android.launcher3.res.R.string.action_increase_width) {
            ...
            lp.cellHSpan ++;
            info.spanX ++;
        } else if (action == com.android.launcher3.res.R.string.action_decrease_width) {
            lp.cellHSpan --;
            info.spanX --;
        } else if (action == com.android.launcher3.res.R.string.action_increase_height) {
            if (!layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1)) {
                lp.cellY --;
                info.cellY --;
            }
            lp.cellVSpan ++;
            info.spanY ++;
        } else if (action == com.android.launcher3.res.R.string.action_decrease_height) {
            lp.cellVSpan --;
            info.spanY --;
        }
        ...
        announceConfirmation(mContext.getString(com.android.launcher3.res.R.string.widget_resized, info.spanX, info.spanY));
        return true;
    }
    ...
    protected boolean beginAccessibleDrag(View item, ItemInfo info, boolean fromKeyboard) {
        ...
        if (fromKeyboard) {
            KeyboardDragAndDropView popup = (KeyboardDragAndDropView) mContext.getLayoutInflater()
                    .inflate(com.android.launcher3.res.R.layout.keyboard_drag_and_drop, mContext.getDragLayer(), false);
    ...
    public boolean addToWorkspace(ItemInfo item, boolean accessibility) {
        ...
        mContext.getStateManager().goToState(NORMAL, true, forSuccessCallback(() -> {
            if (item instanceof WorkspaceItemFactory) {
                ...
                announceConfirmation(com.android.launcher3.res.R.string.item_added_to_workspace);
    ...
    public boolean moveToWorkspace(ItemInfo item) {
        ...
        new Handler().post(() -> {
            ...
            announceConfirmation(com.android.launcher3.res.R.string.item_moved);
        });
        return true;
    }
}
