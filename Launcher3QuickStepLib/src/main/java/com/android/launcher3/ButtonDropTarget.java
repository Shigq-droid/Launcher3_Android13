...
public abstract class ButtonDropTarget extends TextView
    ...
    public ButtonDropTarget(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragDistanceThreshold = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drag_distanceThreshold);
        mDrawableSize = resources.getDimensionPixelSize(com.android.launcher3.res.R.dimen.drop_target_text_size);
        mDrawablePadding = resources.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.drop_target_button_drawable_padding);
    }
    ...
    public final void onDragEnter(DragObject d) {
        if (!mAccessibleDrag && !mTextVisible) {
            ...
            TextView message = (TextView) LayoutInflater.from(getContext()).inflate(
                    com.android.launcher3.res.R.layout.drop_target_tool_tip, null);
