...
public abstract class BaseAllAppsContainerView<T extends Context & ActivityContext
    ...
    protected BaseAllAppsContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrimColor = Themes.getAttrColor(context, com.android.launcher3.res.R.attr.allAppsScrimColor);
        mHeaderThreshold = getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.dynamic_grid_cell_border_spacing);
        mHeaderBottomAdjustment = getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.all_apps_header_bottom_adjustment);
        mHeaderProtectionColor = Themes.getAttrColor(context, com.android.launcher3.res.R.attr.allappsHeaderProtectionColor);
        ...
        mNavBarScrimPaint.setColor(Themes.getAttrColor(context, com.android.launcher3.res.R.attr.allAppsNavBarScrimColor));
    ...
    protected void dispatchRestoreInstanceState(SparseArray<Parcelable> sparseArray) {
        ...
        Bundle state = (Bundle) sparseArray.get(com.android.launcher3.res.R.id.work_tab_state_id, null);
        if (state != null) {
    ...
    protected void dispatchSaveInstanceState(SparseArray<Parcelable> container) {
        ...
        container.put(com.android.launcher3.res.R.id.work_tab_state_id, state);
    }
    ...
    public String getDescription() {
        ...
        if (mUsingTabs) {
            if (cache != null) {
                ...
                return isPersonalTab()
                        ? getContext().getString(com.android.launcher3.res.R.string.all_apps_button_personal_label)
                        : getContext().getString(com.android.launcher3.res.R.string.all_apps_button_work_label);
            }
        }
        return getContext().getString(com.android.launcher3.res.R.string.all_apps_button_label);
    }
    ...
    private View getAppsRecyclerViewContainer() {
        return mViewPager != null ? mViewPager : findViewById(com.android.launcher3.res.R.id.apps_list_view);
    }
    ...
    protected void onFinishInflate() {
        ...
        mHeader = findViewById(com.android.launcher3.res.R.id.all_apps_header);
        mSearchRecyclerView = findViewById(com.android.launcher3.res.R.id.search_results_list_view);
        mAH.get(AdapterHolder.SEARCH).setup(mSearchRecyclerView,
                /* Filter out A-Z apps */ itemInfo -> false);
        rebindAdapters(true /* force */);

        mBottomSheetBackground = findViewById(com.android.launcher3.res.R.id.bottom_sheet_background);
        updateBackground(mActivityContext.getDeviceProfile());

        mBottomSheetHandleArea = findViewById(com.android.launcher3.res.R.id.bottom_sheet_handle_area);
    }
    ...
    protected void rebindAdapters(boolean force) {
        ...
        if (mUsingTabs) {
            ...
            mAH.get(AdapterHolder.WORK).mRecyclerView.setId(com.android.launcher3.res.R.id.apps_list_view_work);
            mViewPager.getPageIndicator().setActiveMarker(AdapterHolder.MAIN);
            findViewById(com.android.launcher3.res.R.id.tab_personal)
            ...
            findViewById(com.android.launcher3.res.R.id.tab_work)
                    .setOnClickListener((View view) -> {
            ...
            mAH.get(AdapterHolder.MAIN).setup(findViewById(com.android.launcher3.res.R.id.apps_list_view), null);
    ...
    private void setDeviceManagementResources() {
        if (mActivityContext.getStringCache() != null) {
            Button personalTab = findViewById(com.android.launcher3.res.R.id.tab_personal);
            personalTab.setText(mActivityContext.getStringCache().allAppsPersonalTab);

            Button workTab = findViewById(com.android.launcher3.res.R.id.tab_work);
    ...
    protected View replaceAppsRVContainer(boolean showTabs) {
        ...
        removeView(oldView);
        int layout = showTabs ? com.android.launcher3.res.R.layout.all_apps_tabs : com.android.launcher3.res.R.layout.all_apps_rv_layout;
    ...
    public boolean isPersonalTabVisible() {
        return isDescendantViewVisible(com.android.launcher3.res.R.id.tab_personal);
    }

    @VisibleForTesting
    public boolean isWorkTabVisible() {
        return isDescendantViewVisible(com.android.launcher3.res.R.id.tab_work);
    }
