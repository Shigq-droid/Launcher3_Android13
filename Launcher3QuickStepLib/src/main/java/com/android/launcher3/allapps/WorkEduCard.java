...
public class WorkEduCard extends FrameLayout implements
    ...
    protected void onFinishInflate() {
        ...
        findViewById(com.android.launcher3.res.R.id.action_btn).setOnClickListener(this);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        findViewById(com.android.launcher3.res.R.id.wrapper).getLayoutParams().width = getTabWidth(getContext(), size);
