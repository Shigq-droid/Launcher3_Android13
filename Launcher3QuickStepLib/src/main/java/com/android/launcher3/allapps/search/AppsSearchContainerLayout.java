...
public class AppsSearchContainerLayout extends ExtendedEditText
    ...
    public AppsSearchContainerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setHint(prefixTextWithIcon(getContext(), com.android.launcher3.res.R.drawable.ic_allapps_search, getHint()));

        mContentOverlap =
                getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_search_bar_content_overlap);
    }
