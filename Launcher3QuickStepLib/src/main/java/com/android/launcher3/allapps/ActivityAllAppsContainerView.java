...
public class ActivityAllAppsContainerView<T extends Context & AppLauncher
    ...
    public String getDescription() {
        if (!mUsingTabs && isSearching()) {
            return getContext().getString(com.android.launcher3.res.R.string.all_apps_search_results);
        } else {
    ...
    private void layoutBelowSearchContainer(View v, boolean includeTabsMargin) {
        ...
        int topMargin = getContext().getResources().getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.all_apps_header_top_margin);
        if (includeTabsMargin) {
            topMargin += getContext().getResources().getDimensionPixelSize(
                    com.android.launcher3.res.R.dimen.all_apps_header_pill_height);
        }
