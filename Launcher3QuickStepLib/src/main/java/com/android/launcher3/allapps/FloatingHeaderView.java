...
public class FloatingHeaderView extends LinearLayout implements
    ...
    public FloatingHeaderView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        mHeaderTopAdjustment = context.getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_header_top_adjustment);
        mHeaderBottomAdjustment = context.getResources()
                .getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_header_bottom_adjustment);
        mHeaderProtectionSupported = context.getResources().getBoolean(
                com.android.launcher3.res.R.bool.config_header_protection_supported)
    ...
    protected void onFinishInflate() {
        ...
        mTabLayout = findViewById(com.android.launcher3.res.R.id.tabs);
    ...
    public int getMaxTranslation() {
        if (mMaxTranslation == 0 && mTabsHidden) {
            return getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_search_bar_bottom_padding);
