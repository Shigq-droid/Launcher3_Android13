...
public class WorkModeSwitch extends Button implements Insettable, View.OnClickListener,
    ...
    public void setInsets(Rect insets) {
        ...
        if (lp != null) {
            int bottomMargin = getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.work_fab_margin_bottom);
            if (FeatureFlags.ENABLE_FLOATING_SEARCH_BAR.get()) {
                bottomMargin <<= 1;  // Double margin to add space above search bar.
                bottomMargin += getResources().getDimensionPixelSize(com.android.launcher3.res.R.dimen.qsb_widget_height);
            }
