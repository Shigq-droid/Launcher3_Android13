...
public class AllAppsRecyclerView extends FastScrollRecyclerView {
    ...
    public AllAppsRecyclerView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mEmptySearchBackgroundTopOffset = res.getDimensionPixelSize(
                com.android.launcher3.res.R.dimen.all_apps_empty_search_bg_top_offset);
    ...
    public int getScrollBarTop() {
        return getResources().getDimensionPixelOffset(com.android.launcher3.res.R.dimen.all_apps_header_top_padding);
    }
