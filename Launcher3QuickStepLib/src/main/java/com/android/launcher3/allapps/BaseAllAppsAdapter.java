...
public abstract class BaseAllAppsAdapter<T extends Context & ActivityContext> extends
    ...
    public BaseAllAppsAdapter(T activityContext, LayoutInflater inflater,
        ...
        mApps = apps;
        mEmptySearchMessage = res.getString(com.android.launcher3.res.R.string.all_apps_loading_message);
        mLayoutInflater = inflater;

        mOnIconClickListener = mActivityContext.getItemOnClickListener();

        mAdapterProviders = adapterProviders;
        mExtraHeight = res.getDimensionPixelSize(com.android.launcher3.res.R.dimen.all_apps_height_extra);
    }
    ...
    public void setLastSearchQuery(String query, OnClickListener marketSearchClickListener) {
        ...
        mEmptySearchMessage = res.getString(com.android.launcher3.res.R.string.all_apps_no_search_results, query);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_ICON:
                int layout = !FeatureFlags.ENABLE_TWOLINE_ALLAPPS.get() ? com.android.launcher3.res.R.layout.all_apps_icon
                        : com.android.launcher3.res.R.layout.all_apps_icon_twoline;
            ...
            case VIEW_TYPE_EMPTY_SEARCH:
                return new ViewHolder(mLayoutInflater.inflate(com.android.launcher3.res.R.layout.all_apps_empty_search,
                        parent, false));
            case VIEW_TYPE_SEARCH_MARKET:
                View searchMarketView = mLayoutInflater.inflate(com.android.launcher3.res.R.layout.all_apps_search_market,
                        parent, false);
                searchMarketView.setOnClickListener(mMarketSearchClickListener);
                return new ViewHolder(searchMarketView);
            case VIEW_TYPE_ALL_APPS_DIVIDER:
                return new ViewHolder(mLayoutInflater.inflate(
                        com.android.launcher3.res.R.layout.all_apps_divider, parent, false));
            default:
