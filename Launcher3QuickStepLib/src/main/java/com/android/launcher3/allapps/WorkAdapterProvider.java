...
public class WorkAdapterProvider extends BaseAdapterProvider {
    ...
    public AllAppsGridAdapter.ViewHolder onCreateViewHolder(LayoutInflater layoutInflater,
        ...
        int viewId = viewType == VIEW_TYPE_WORK_DISABLED_CARD ? com.android.launcher3.res.R.layout.work_apps_paused
                : com.android.launcher3.res.R.layout.work_apps_edu;
    ...
    private void setWorkProfilePausedResources(View view, StringCache cache) {
        TextView title = view.findViewById(com.android.launcher3.res.R.id.work_apps_paused_title);
        title.setText(cache.workProfilePausedTitle);

        TextView body = view.findViewById(com.android.launcher3.res.R.id.work_apps_paused_content);
        body.setText(cache.workProfilePausedDescription);

        TextView button = view.findViewById(com.android.launcher3.res.R.id.enable_work_apps);
